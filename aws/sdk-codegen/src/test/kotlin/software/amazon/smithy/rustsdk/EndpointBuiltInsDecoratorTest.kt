...
class EndpointBuiltInsDecoratorTest {
    ...
    fun accountIdBuiltInParam() {
        ...
        // This model operates without authentication. It uses `NoAuthScheme`, which causes
        // `NoAuthIdentityResolver` to return `NoAuthIdentity`. Since `NoAuthIdentity` doesn't contain
        // an account ID, account-based routing is effectively disabled.
        ...
        // containing an account ID. This should exercise an endpoint rule that match requests
        // with account IDs.
        runTest(
