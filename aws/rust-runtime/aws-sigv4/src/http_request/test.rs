...
impl TestRequest {
    ...
    pub(crate) fn as_http_request(&self) -> http_1x::Request<&'static str> {
        let mut builder = http_1x::Request::builder()
            .uri(&self.uri)
...
impl<B: AsRef<[u8]>> From<http_1x::Request<B>> for TestRequest {
    fn from(value: http_1x::Request<B>) -> Self {
        let invalid = value
            .headers()
            .values()
