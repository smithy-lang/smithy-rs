...
//
// Although fields like `disableDoubleEncoding` and `disableNormalizePath` are rarely specified
// (only by S3 and S3Control), this implementation may need to be extended in the future
