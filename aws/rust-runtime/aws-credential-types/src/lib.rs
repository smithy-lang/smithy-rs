...
//! [`ProvideCredentials`](crate::ProvideCredentials). Generally, this is best done by
//! defining an inherent `async fn` on your structure, then calling that method directly from
//! the trait implementation.
//! ```rust
//! use aws_credential_types::{CredentialsError, Credentials, ProvideCredentials, future};
//! #[derive(Debug)]
...
//! fn parse_credentials(creds: &str) -> aws_credential_types::Result {
