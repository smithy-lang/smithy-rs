...
impl DoNothingFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::do_nothing::DoNothingOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::do_nothing::DoNothingError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::do_nothing::DoNothingOutput, crate::operation::do_nothing::DoNothingError, Self> {
