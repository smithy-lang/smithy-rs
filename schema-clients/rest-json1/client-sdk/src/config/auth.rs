...
/// Auth scheme resolver trait specific to Pokémon Service
                    ...
                    T: ResolveAuthScheme,
                {
                    fn resolve_auth_scheme_options_v2<'a>(
                        ...
                        match params.get::<crate::config::auth::Params>() {
                            ...
                            ::std::option::Option::None => ::aws_smithy_runtime_api::client::auth::AuthSchemeOptionsFuture::ready(::std::result::Result::Err("params of expected type was not present".into())),
                        }
                    }
                }
...
/// The default auth scheme resolver
                ...
                impl Default for DefaultAuthSchemeResolver {
                    fn default() -> Self {
                        Self {
                            service_defaults: vec![::aws_smithy_runtime_api::client::auth::AuthSchemeOption::from(::aws_smithy_runtime::client::auth::no_auth::NO_AUTH_SCHEME_ID)],
