...
impl StreamPokemonRadio {
    ...
    /// The schema for this operation's input shape.
                        pub const INPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = crate::operation::stream_pokemon_radio::StreamPokemonRadioInput::SCHEMA;
                        /// The schema for this operation's output shape.
                        pub const OUTPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = crate::operation::stream_pokemon_radio::StreamPokemonRadioOutput::SCHEMA;
    pub(crate) async fn orchestrate(
                        runtime_plugins: &::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugins,
                        input: crate::operation::stream_pokemon_radio::StreamPokemonRadioInput,
                    ) -> ::std::result::Result<crate::operation::stream_pokemon_radio::StreamPokemonRadioOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stream_pokemon_radio::StreamPokemonRadioError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::stream_pokemon_radio::StreamPokemonRadioError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::stream_pokemon_radio::StreamPokemonRadioOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StreamPokemonRadio {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    ...
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StreamPokemonRadioRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StreamPokemonRadioResponseDeserializer));
...
.with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(StreamPokemonRadioEndpointParamsInterceptor))
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::stream_pokemon_radio::StreamPokemonRadioError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::stream_pokemon_radio::StreamPokemonRadioError>::new());
...
::std::result::Result::Err(::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::operation(::aws_smithy_runtime_api::client::interceptors::context::Error::erase(crate::operation::stream_pokemon_radio::StreamPokemonRadioError::generic(generic))))
                }
            }
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StreamPokemonRadioRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::stream_pokemon_radio::StreamPokemonRadioInput>().expect("correct type");

                    let protocol = _cfg.load::<::aws_smithy_schema::protocol::SharedClientProtocol>()
                        .expect("a SharedClientProtocol is required");
                    let mut request = protocol.serialize_request(
                        &input, StreamPokemonRadio::INPUT_SCHEMA, "", _cfg,
