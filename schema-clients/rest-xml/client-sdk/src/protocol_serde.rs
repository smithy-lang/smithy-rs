...
pub fn parse_event_stream_error_metadata(payload: &::bytes::Bytes) -> ::std::result::Result<::aws_smithy_types::error::metadata::Builder, ::aws_smithy_xml::decode::XmlDecodeError> {
    crate::rest_xml_wrapped_errors::parse_error_metadata(payload.as_ref())
}

pub fn error_body_contents(body: &[u8]) -> &[u8] {
    ::aws_smithy_xml::protocol::aws_rest_xml::find_error_element_slice(body)
}
