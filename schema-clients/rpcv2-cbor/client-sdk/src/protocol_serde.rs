...
pub fn parse_event_stream_error_metadata(payload: &::bytes::Bytes) -> ::std::result::Result<::aws_smithy_types::error::metadata::Builder, ::aws_smithy_cbor::decode::DeserializeError> {
