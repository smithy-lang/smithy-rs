...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CapturePokemonRequestSerializer {
                ...
                &input, CapturePokemon::INPUT_SCHEMA, "/service/PokemonService/operation/CapturePokemon", _cfg,
...
request.headers_mut().insert("accept", "application/vnd.amazon.eventstream, application/cbor");
