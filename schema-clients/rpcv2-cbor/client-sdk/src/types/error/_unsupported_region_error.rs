                ...
                pub fn deserialize(deserializer: &mut dyn ::aws_smithy_schema::serde::ShapeDeserializer) -> ::std::result::Result<Self, ::aws_smithy_schema::serde::SerdeError> {
                    ...
                    deserializer.read_struct(&UNSUPPORTEDREGIONERROR_SCHEMA, &mut |member, deser| {
                        match member.member_index() {
                            Some(0) => { builder.region = Some(deser.read_string(member)?); }
Some(1) => {
...
impl UnsupportedRegionErrorBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::error::UnsupportedRegionError, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::error::UnsupportedRegionError {
                region: self.region
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("region", "region was not specified but it is required when building UnsupportedRegionError")
                    )?
                ,
