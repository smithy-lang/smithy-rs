...
/// Configuration for a pokemon_service_protocols_rpcv2_cbor_client_sdk service client.
///
...
impl Builder {
    ...
    /// Names operation-input members whose values are captured *and* emitted as
                            ...
                            pub fn emit_input_attributes(
                                ...
                                let mut requested = self.config.load::<::aws_smithy_types::telemetry::RequestedTelemetryAttributes>().cloned().unwrap_or_default();
    ...
    /// Sets the client protocol to use for serialization and deserialization.
                            ...
                            pub fn protocol(mut self, protocol: impl ::aws_smithy_schema::protocol::ClientProtocol + 'static) -> Self {
                                self.set_protocol(::std::option::Option::Some(::aws_smithy_schema::protocol::SharedClientProtocol::new(protocol)));
                                self
                            }
    ...
    /// Sets the HTTP client to use when making requests.
                            ...
                            /// use pokemon_service_protocols_rpcv2_cbor_client_sdk::config::Config;
                            ...
                            /// # fn example() {
                            /// use std::time::Duration;
                            /// use pokemon_service_protocols_rpcv2_cbor_client_sdk::config::{Builder, Config};
                            /// use aws_smithy_runtime::client::http::hyper_014::HyperClientBuilder;
                            ///
                            ...
                            /// }
                            ///
                            /// let mut builder = pokemon_service_protocols_rpcv2_cbor_client_sdk::Config::builder();
    ...
    /// Adds an auth scheme to the builder
                            ...
                            /// impl pokemon_service_protocols_rpcv2_cbor_client_sdk::config::auth::ResolveAuthScheme for CustomAuthSchemeResolver {
                            ///     fn resolve_auth_scheme<'a>(
                            ///         &'a self,
                            ///         _params: &'a pokemon_service_protocols_rpcv2_cbor_client_sdk::config::auth::Params,
                            ///         _cfg: &'a ConfigBag,
                            ///         _runtime_components: &'a RuntimeComponents,
                            ...
                            /// }
                            ///
                            /// let config = pokemon_service_protocols_rpcv2_cbor_client_sdk::Config::builder()
                            ...
                            pub fn set_auth_scheme_resolver(&mut self, auth_scheme_resolver: impl crate::config::auth::ResolveAuthScheme + 'static) -> &mut Self {
                                self.runtime_components.set_auth_scheme_option_resolver(::std::option::Option::Some(auth_scheme_resolver.into_shared_resolver()));
                                self
                            }
    ...
    /// Set the auth scheme preference for an auth scheme resolver
                            ...
                            ///     // ...
                            ///     .build();
                            /// let client = pokemon_service_protocols_rpcv2_cbor_client_sdk::Client::from_conf(config);
                            /// ```

                            pub fn auth_scheme_preference(mut self, preference: impl ::std::convert::Into<::aws_smithy_runtime_api::client::auth::AuthSchemePreference>) -> Self {
                            ...
                            pub fn set_auth_scheme_preference(&mut self, preference: ::std::option::Option<::aws_smithy_runtime_api::client::auth::AuthSchemePreference>) -> &mut Self {
    ...
    /// Sets the endpoint resolver to use when making requests.
                            ...
                            /// ```no_run
                            /// use pokemon_service_protocols_rpcv2_cbor_client_sdk::config::endpoint::{ResolveEndpoint, EndpointFuture, Params, Endpoint};
                            /// #[derive(Debug)]
                            ...
                            /// let config = pokemon_service_protocols_rpcv2_cbor_client_sdk::Config::builder().endpoint_resolver(resolver).build();
                            /// let client = pokemon_service_protocols_rpcv2_cbor_client_sdk::Client::from_conf(config);
                            /// ```
    ...
    /// Set the retry_config for the builder
                            ...
                            /// ```no_run
                            /// use pokemon_service_protocols_rpcv2_cbor_client_sdk::config::Config;
                            /// use pokemon_service_protocols_rpcv2_cbor_client_sdk::config::retry::RetryConfig;
                            ///
    ...
    /// Set the sleep_impl for the builder
                            ...
                            ///
                            /// ```no_run
                            /// use pokemon_service_protocols_rpcv2_cbor_client_sdk::config::{AsyncSleep, Config, SharedAsyncSleep, Sleep};
                            ///
                            /// #[derive(Debug)]
                            ...
                            ///
                            /// ```no_run
                            /// use pokemon_service_protocols_rpcv2_cbor_client_sdk::config::{AsyncSleep, Builder, Config, SharedAsyncSleep, Sleep};
                            ///
                            /// #[derive(Debug)]
                            /// pub struct ForeverSleep;
                            ///
    ...
    /// Set the timeout_config for the builder
                            ...
                            /// # use std::time::Duration;
                            /// use pokemon_service_protocols_rpcv2_cbor_client_sdk::config::Config;
                            /// use pokemon_service_protocols_rpcv2_cbor_client_sdk::config::timeout::TimeoutConfig;
                            ///
    ...
    /// Set the partition for retry-related state. When clients share a retry partition, they will
                            ...
                            /// ```no_run
                            /// use pokemon_service_protocols_rpcv2_cbor_client_sdk::config::Config;
                            /// use pokemon_service_protocols_rpcv2_cbor_client_sdk::config::retry::{RetryPartition, TokenBucket};
                            ///
                            ...
                            /// ```no_run
                            /// use pokemon_service_protocols_rpcv2_cbor_client_sdk::config::Config;
                            /// use pokemon_service_protocols_rpcv2_cbor_client_sdk::config::retry::{ClientRateLimiter, RetryConfig, RetryPartition};
                            ///
    ...
    /// Set the identity cache for auth.
                            ...
                            /// ```no_run
                            /// use pokemon_service_protocols_rpcv2_cbor_client_sdk::config::IdentityCache;
                            ///
                            /// let config = pokemon_service_protocols_rpcv2_cbor_client_sdk::Config::builder()
    ...
    /// Add type implementing [`ClassifyRetry`](::aws_smithy_runtime_api::client::retries::classifiers::ClassifyRetry) that will be used by the
                            ...
                            /// #    fn meta(&self) -> &pokemon_service_protocols_rpcv2_cbor_client_sdk::error::ErrorMetadata { todo!() }
                            /// # }
                            ///
    ...
    /// Sets the [`behavior major version`](crate::config::BehaviorVersion).
                    ...
                    /// ```no_run
                    /// use pokemon_service_protocols_rpcv2_cbor_client_sdk::config::BehaviorVersion;
                    ///
                    /// let config = pokemon_service_protocols_rpcv2_cbor_client_sdk::Config::builder()
    ...
    pub fn with_test_defaults_v2(mut self) -> Self {
        self.apply_test_defaults_v2(); self
    }
    /// Builds a [`Config`].
    #[allow(unused_mut)]
    pub fn build(mut self) -> Config {
        ...
        Config {
            config: crate::config::Layer::from(layer.clone()).with_name("pokemon_service_protocols_rpcv2_cbor_client_sdk::config::Config").freeze(),
                                    cloneable: layer,
...
#[derive(::std::fmt::Debug)]
            ...
            impl ServiceRuntimePlugin {
                pub fn new(_service_config: crate::config::Config) -> Self {
                    let config = { let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PokemonService");
                            cfg.store_put(::aws_smithy_schema::protocol::ServiceShapeName::new("PokemonService"));
                        cfg.store_put(::aws_smithy_schema::protocol::ServiceVersion::new("2024-03-18"));
if _service_config.protocol().is_none() {
                            cfg.store_put(
                                ::aws_smithy_schema::protocol::SharedClientProtocol::new(::aws_smithy_cbor::protocol::RpcV2CborProtocol::new())
                            );
                        }
cfg.store_put(::aws_smithy_runtime::client::orchestrator::AuthSchemeAndEndpointOrchestrationV2);
                            ::std::option::Option::Some(cfg.freeze()) };
                    let mut runtime_components = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ServiceRuntimePlugin");
                    runtime_components.push_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(crate::sdk_feature_tracker::rpc_v2_cbor::RpcV2CborFeatureTrackerInterceptor::new()));
...
runtime_components.push_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(::aws_smithy_runtime::client::http::connection_poisoning::ConnectionPoisoningInterceptor::new()));
runtime_components.push_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::HttpStatusCodeClassifier::default());
runtime_components.push_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(crate::sdk_feature_tracker::retry_mode::RetryModeFeatureTrackerInterceptor::new()));
            ...
            impl ConfigOverrideRuntimePlugin {
                ...
                pub(crate) fn new(
                    ...
                    if components.has_identity_resolvers() && components.identity_cache().is_none() {
                        components.set_identity_cache(::std::option::Option::Some(::aws_smithy_runtime::client::identity::IdentityCache::lazy().max_partitions(1).build()));
                    }

                    Self {
                        config: ::aws_smithy_types::config_bag::Layer::from(layer)
                            .with_name("pokemon_service_protocols_rpcv2_cbor_client_sdk::config::ConfigOverrideRuntimePlugin").freeze(),
                        components,
                    }
                }
            }
...
pub(crate) fn base_client_runtime_plugins(
    ...
    if config.behavior_version.is_none() {
                    ...
                    let scope = "pokemon-service-protocols-rpcv2-cbor-client-sdk";
