// Code generated by software.amazon.smithy.rust.codegen.smithy-rs. DO NOT EDIT.
                ...
                impl<Body, L, HttpPl, ModelPl> PokemonServiceBuilder<Body, L, HttpPl, ModelPl> {
                    ...
                    ///
                    /// ```no_run
                    /// use pokemon_service_dynamic_server_sdk::{PokemonService, PokemonServiceConfig};
                    ///
                    /// use pokemon_service_dynamic_server_sdk::{input, output};
                    ///
...
/// }
...

                    {
                        ...
                        let svc = ::aws_smithy_http_server::operation::DynUpgradePlugin::<UpgradeExtractors>::new(0usize).apply(svc);
...
/// }
                ...
                pub fn build(self) -> ::std::result::Result<
                    PokemonService<::aws_smithy_http_server::routing::MultiProtocolRoutingService<L::Service>>,
                    ...
                    L: ::tower::Layer<::aws_smithy_http_server::routing::Route<Body>>,
                {
                    let svc = {
                        ...
                        ::aws_smithy_http_server::routing::MultiProtocolRoutingService::from_operation_handler_bindings(
...
self.get_server_statistics.expect(unexpected_error_msg)
                ...
                where
                    Body: Send + 'static,
                    L: ::tower::Layer<::aws_smithy_http_server::routing::MultiProtocolRoutingService<::aws_smithy_http_server::routing::Route<Body>>>
                {
                    let svc = self
                        .layer
                        .layer(::aws_smithy_http_server::routing::MultiProtocolRoutingService::from_operation_handler_bindings(
                    &crate::schema::POKEMON_SERVICE,
                    [],
                    [::aws_smithy_http_server::routing::OperationHandlerBinding::new(
                    &crate::schema::operations::GET_SERVER_STATISTICS,
...
///
                ...
                pub struct PokemonService<
                    S = ::aws_smithy_http_server::routing::MultiProtocolRoutingService<::aws_smithy_http_server::routing::Route<::aws_smithy_http_server::body::Body>>
                > {
                ...
                impl<S> PokemonService<::aws_smithy_http_server::routing::MultiProtocolRoutingService<S>> {
...
/// Configuration for the [`PokemonService`]. This is the central place where to register and
            ...
            ///
            /// ```rust,no_run
            /// # use pokemon_service_dynamic_server_sdk::PokemonServiceConfig;
...
/// A macro to help with scoping [plugins](crate::server::plugin) to a subset of all operations.
                ...
                /// }
                ///
                /// # use pokemon_service_dynamic_server_sdk::server::plugin::{Plugin, Scoped};
                /// # use pokemon_service_dynamic_server_sdk::scope;
                /// # struct MockPlugin;
                ...
                /// # let a = Plugin::<(), pokemon_service_dynamic_server_sdk::operation_shape::GetServerStatistics, u64>::apply(&scoped_a, 6);
                /// # let b = Plugin::<(), pokemon_service_dynamic_server_sdk::operation_shape::GetServerStatistics, u64>::apply(&scoped_b, 6);
                /// # assert_eq!(a, 3_u32);
                /// # assert_eq!(b, 6_u64);
                /// ```
                #[macro_export]
