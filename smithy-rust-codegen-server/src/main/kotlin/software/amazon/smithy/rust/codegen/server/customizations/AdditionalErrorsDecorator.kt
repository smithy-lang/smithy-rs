...
import software.amazon.smithy.rust.codegen.core.transformers.allErrors
 ...
 * ```
 * C="software.amazon.smithy.rust.codegen.server.customizations.AddInternalServerErrorToInfallibleOperationsDecorator"
 ...
 * To enable this decorator write its class name to a resource file like this:
 * ```
 * C="software.amazon.smithy.rust.codegen.server.customizations.AddInternalServerErrorToAllOperationsDecorator"
 * F="software.amazon.smithy.rust.codegen.smithy.customize.RustCodegenDecorator"
 * D="codegen-server/src/main/resources/META-INF/services"
 * mkdir -p "$D" && echo "$C" > "$D/$F"
 * ```
