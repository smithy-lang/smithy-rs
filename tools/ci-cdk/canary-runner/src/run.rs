...
pub struct RunArgs {
    ...
    #[clap(long)]
    expected_speech_text_by_transcribe: String,
...
async fn run_canary(options: &Options, config: &aws_config::SdkConfig) -> Result<Duration> {
    ...
    create_lambda_fn(
        ...
        &options.expected_speech_text_by_transcribe,
        &options.lambda_code_s3_bucket_name,
...
async fn create_lambda_fn(
    ...
    execution_role: &str,
    expected_speech_text_by_transcribe: &str,
    code_s3_bucket: &str,
    test_s3_bucket: &str,
) -> Result<()> {
    use lambda::model::*;
    ...
    fn args_parsing() {
        assert_eq!(
            RunArgs {
                ...
                musl: false,
                expected_speech_text_by_transcribe: "Good day to you transcribe.".to_owned(),
