...
pub struct RunArgs {
    ...
    /// Lambda architecture
    #[clap(long, default_value = "x86_64", possible_values = &["x86_64", "aarch64"])]
    architecture: Arch,
...
async fn create_lambda_fn(
    ...
    lambda_client
        ...
        .architectures(options.architecture.into())
        .send()
        .await
...
#[cfg(test)]
mod tests {
    use crate::run::{Arch, Options, RunArgs, DEFAULT_LAMBDA_FUNCTION_MEMORY_SIZE_IN_MB};
    use clap::Parser;
