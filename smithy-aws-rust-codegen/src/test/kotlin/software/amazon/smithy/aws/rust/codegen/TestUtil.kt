    ...
    TestRuntimeConfig.copy(
        runtimeCrateLocation =
            run {
                ...
                check(path.exists()) { "${path.absolutePath} must exist to generate a working SDK" }
                ...
                ObjectNode.builder()
                    .withMember(
                        ...
                        ObjectNode.builder()
                            ...
                            .withMember("integrationTestPath", "../aws/sdk/integration-tests")
                            .withMember("partitionsConfigPath", "../aws/sdk/aws-models/sdk-partitions.json")
                            .build(),
                    ).build(),
            )
                .withMember(
