 ...
 *
 * This generator is meant for use by the server project. Clients use the [ClientBuilderGenerator] from the `codegen-client`
 ...
 *
 * These are the main differences with the builders generated by the client's [ClientBuilderGenerator]:
 *
...
class ServerBuilderGenerator(
     ...
     * exposed to.
     *
     * See [software.amazon.smithy.rust.codegen.server.smithy.generators.PubCrateConstrainedCollectionGenerator] too.
     */
