...
import software.amazon.smithy.rust.codegen.server.js.smithy.customizations.DECORATORS
 ...
 */
class JsCodegenServerPlugin : SmithyBuildPlugin {
    private val logger = Logger.getLogger(javaClass.name)

    override fun getName(): String = "rust-server-codegen-js"
    ...
    override fun execute(context: PluginContext) {
        ...
        JsServerCodegenVisitor(context, codegenDecorator).execute()
    }
    ...
    companion object {
        ...
        fun baseSymbolProvider(
            ...
            JsServerSymbolVisitor(model, serviceShape = serviceShape, config = symbolVisitorConfig)
                ...
                .let { JsStreamingShapeMetadataProvider(it, model) }
