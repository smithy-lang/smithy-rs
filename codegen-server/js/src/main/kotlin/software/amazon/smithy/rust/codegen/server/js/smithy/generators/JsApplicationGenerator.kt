...
class JsApplicationGenerator(
    ...
    private val codegenScope =
        arrayOf(
            ...
            "tower_http" to JsServerCargoDependency.TowerHttp.toType(),
            "num_cpus" to JsServerCargoDependency.NumCpus.toType(),
            "hyper" to JsServerCargoDependency.Hyper.toType(),
            "HashMap" to RuntimeType.HashMap,
            "parking_lot" to JsServerCargoDependency.ParkingLot.toType(),
