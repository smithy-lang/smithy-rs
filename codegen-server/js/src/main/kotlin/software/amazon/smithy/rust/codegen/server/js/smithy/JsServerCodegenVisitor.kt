...
import software.amazon.smithy.rust.codegen.server.js.smithy.generators.JsServerEnumGenerator
import software.amazon.smithy.rust.codegen.server.js.smithy.generators.JsServerOperationHandlerGenerator
import software.amazon.smithy.rust.codegen.server.js.smithy.generators.JsServerServiceGenerator
import software.amazon.smithy.rust.codegen.server.js.smithy.generators.JsServerStructureGenerator
...
class JsServerCodegenVisitor(
    ...
    init {
        ...
        ) = JsCodegenServerPlugin.baseSymbolProvider(model, serviceShape, symbolVisitorConfig, publicConstrainedTypes)
    ...
    override fun structureShape(shape: StructureShape) {
        ...
        rustCrate.useShapeWriter(shape) {
            ...
            JsServerStructureGenerator(model, codegenContext.symbolProvider, this, shape).render(CodegenTarget.SERVER)
    ...
    override fun stringShape(shape: StringShape) {
        fun jsServerEnumGeneratorFactory(codegenContext: ServerCodegenContext, writer: RustWriter, shape: StringShape) =
            JsServerEnumGenerator(codegenContext, writer, shape)
        stringShape(shape, ::jsServerEnumGeneratorFactory)
    }
    ...
    override fun operationShape(shape: OperationShape) {
        ...
        rustCrate.withModule(RustModule.public("js_operation_adaptor")) {
            JsServerOperationHandlerGenerator(codegenContext, shape).render(this)
        }
    }
}
