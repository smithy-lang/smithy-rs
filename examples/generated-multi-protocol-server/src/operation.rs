...
::pin_project_lite::pin_project! {
    /// A [`Future`](std::future::Future) aggregating the body bytes of a [`Request`] and constructing the
    /// [`DoNothingInput`](crate::input::DoNothingInput) using schema-driven bindings.
        ...
        From<<B as ::aws_smithy_http_server::body::HttpBody>::Error>,
{
    ...
    fn from_request(request: ::http_1x::Request<B>) -> Self::Future {
        let fut = async move {
            ...
            <::aws_smithy_http_server::protocol::rest_json_1::RestJson1 as ::aws_smithy_http_server::schema::protocol::ServerProtocol>::deserialize_request::<crate::input::DoNothingInput>(crate::input::DoNothingInput::SCHEMA, crate::output::DoNothingOutput::SCHEMA, &parts, bytes.as_ref())
        };
        use ::futures_util::future::TryFutureExt;
        let fut = fut.map_err(
            |e: ::aws_smithy_http_server::protocol::rest_json_1::rejection::RequestRejection| {
...
impl<P: ::aws_smithy_http_server::schema::protocol::ServerProtocol>
    ::aws_smithy_http_server::response::IntoResponse<P> for crate::output::DoNothingOutput
{
    fn into_response(self) -> ::aws_smithy_http_server::response::Response {
...
::pin_project_lite::pin_project! {
    /// A [`Future`](std::future::Future) aggregating the body bytes of a [`Request`] and constructing the
    /// [`CheckHealthInput`](crate::input::CheckHealthInput) using schema-driven bindings.
        ...
        From<<B as ::aws_smithy_http_server::body::HttpBody>::Error>,
{
    ...
    fn from_request(request: ::http_1x::Request<B>) -> Self::Future {
        let fut = async move {
            ...
            <::aws_smithy_http_server::protocol::rest_json_1::RestJson1 as ::aws_smithy_http_server::schema::protocol::ServerProtocol>::deserialize_request::<crate::input::CheckHealthInput>(crate::input::CheckHealthInput::SCHEMA, crate::output::CheckHealthOutput::SCHEMA, &parts, bytes.as_ref())
        };
        use ::futures_util::future::TryFutureExt;
        let fut = fut.map_err(
            |e: ::aws_smithy_http_server::protocol::rest_json_1::rejection::RequestRejection| {
...
impl<P: ::aws_smithy_http_server::schema::protocol::ServerProtocol>
    ::aws_smithy_http_server::response::IntoResponse<P> for crate::output::CheckHealthOutput
{
    fn into_response(self) -> ::aws_smithy_http_server::response::Response {
        P::serialize_response(Self::SCHEMA, &self)
    }
