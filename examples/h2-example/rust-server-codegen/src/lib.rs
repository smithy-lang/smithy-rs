...
//! # async fn dummy() {
//! use your_service_server::{SampleService, SampleServiceConfig};
//!
...
//!
//! ```rust,ignore
//! use your_service_server::server::routing::LambdaHandler;
//! use your_service_server::SampleService;
//!
//! # async fn dummy() {
//! # let app = SampleService::builder(
//! #     SampleServiceConfig::builder()
...
//!
//! ```rust,no_run
//! # use your_service_server::server::plugin::IdentityPlugin as LoggingPlugin;
//! # use your_service_server::server::plugin::IdentityPlugin as MetricsPlugin;
//! # use ::hyper::Body;
//! use your_service_server::server::plugin::HttpPlugins;
//! use your_service_server::{SampleService, SampleServiceConfig, SampleServiceBuilder};
//!
...
//! # struct State;
//! # use std::net::SocketAddr;
//! use your_service_server::server::request::{extension::Extension, connect_info::ConnectInfo};
//!
...
//! }
//!
//! use your_service_server::{input, output, error};
//!
