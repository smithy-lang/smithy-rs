    ...
    Ok({
        ...
        let body = ::aws_smithy_http_server::body::boxed(::aws_smithy_http_server::body::wrap_stream(
            /* ServerProtocolLoader.kt:47 */::aws_smithy_http::futures_stream_adapter::FuturesStreamCompatByteStream::new(
                /* HttpBoundProtocolPayloadGenerator.kt:357 */crate::protocol_aws_json1_0::protocol_serde::shape_stream_pokemon_radio_output::ser_data_http_payload( output.data)?
