...
pub fn ser_resource_not_found_exception_error(
    ...
    crate::protocol_aws_json1_1::protocol_serde::shape_resource_not_found_exception::ser_resource_not_found_exception(&mut object, value)?;
    /* ServerAwsJson.kt:95 */
    object.key("__type").string("ResourceNotFoundException");
