...
pub fn ser_validation_exception_error(
    ...
    crate::protocol_aws_json1_1::protocol_serde::shape_validation_exception::ser_validation_exception(&mut object, value)?;
    /* ServerAwsJson.kt:95 */
    ...
    if let Some(var_1) = &input.field_list {
        ...
        for item_3 in var_1 {
            /* SerializerUtil.kt:42 */
            {
                ...
                /* JsonSerializerGenerator.kt:377 */
                crate::protocol_aws_json1_1::protocol_serde::shape_validation_exception_field::ser_validation_exception_field(&mut object_4, item_3)?;
