...
pub fn ser_get_pokemon_species_output_output_output(
    ...
    crate::protocol_rest_json1::protocol_serde::shape_get_pokemon_species_output::ser_get_pokemon_species_output_output(&mut object, value)?;
    ...
    /* SerializerUtil.kt:42 */
    {
        ...
        for item_2 in &input.flavor_text_entries {
            /* SerializerUtil.kt:42 */
            {
                ...
                /* JsonSerializerGenerator.kt:377 */
                crate::protocol_rest_json1::protocol_serde::shape_flavor_text::ser_flavor_text(
                    &mut object_3,
                    item_2,
                )?;
