...
> {
    Ok({
        ...
        let payload =
            crate::protocol_serde::shape_get_storage_output::ser_get_storage_output_output_output(&output)?
        ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn ser_get_storage_http_error(error: &crate::error::GetStorageError) -> std::result::Result<::aws_smithy_http_server::response::Response, ::aws_smithy_http_server::protocol::rest_json_1::rejection::ResponseRejection> {
    Ok({
        match error {
