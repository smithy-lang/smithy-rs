...
/// The service builder for [`PokemonService`].
                ...
                pub struct PokemonServiceBuilder<Body, L, HttpPl, ModelPl> {
                    capture_pokemon: Option<::aws_smithy_http_server::routing::Route<Body>>, check_health: Option<::aws_smithy_http_server::routing::Route<Body>>, do_nothing: Option<::aws_smithy_http_server::routing::Route<Body>>, get_server_statistics: Option<::aws_smithy_http_server::routing::Route<Body>>,
                    layer: L,
                    http_plugin: HttpPl,
                ...
                impl<Body, L, HttpPl, ModelPl> PokemonServiceBuilder<Body, L, HttpPl, ModelPl> {
                    ...
                    ///
                    /// ```no_run
                    /// use pokemon_service_protocols_aws_json_11_server_sdk::{PokemonService, PokemonServiceConfig};
                    ///
                    /// use pokemon_service_protocols_aws_json_11_server_sdk::{input, output, error};
                    ///
...
/// }
                    ...
                    ///     .build()
                    ///     .unwrap();
                    /// # let app: PokemonService<::aws_smithy_http_server::routing::RoutingService<::aws_smithy_http_server::protocol::aws_json::router::AwsJsonRouter<::aws_smithy_http_server::routing::Route>, ::aws_smithy_http_server::protocol::aws_json_11::AwsJson1_1>> = app;
                    /// ```
                    ///
...
if self.get_server_statistics.is_none() {
                        ...
                        <::aws_smithy_http_server::protocol::aws_json_11::AwsJson1_1 as ::aws_smithy_http_server::routing::RouterForOperationHandlerBindings<
...
self.get_server_statistics.expect(unexpected_error_msg)
                ...
                where
                    Body: Send + 'static,
                    L: ::tower::Layer<
                        ::aws_smithy_http_server::routing::RoutingService<::aws_smithy_http_server::protocol::aws_json::router::AwsJsonRouter<::aws_smithy_http_server::routing::Route<Body>>, ::aws_smithy_http_server::protocol::aws_json_11::AwsJson1_1>
                    >
                {
                    let svc = self
                        .layer
                        .layer(<::aws_smithy_http_server::protocol::aws_json_11::AwsJson1_1 as ::aws_smithy_http_server::routing::RouterForOperationHandlerBindings<
                                ::aws_smithy_http_server::routing::Route<Body>
                            >>::build_routing_service(
                                &crate::schema::POKEMON_SERVICE,
                                [::aws_smithy_http_server::routing::OperationHandlerBinding::new(
...
, get_server_statistics: None,
            ...
            /// An enumeration of all [operations](https://smithy.io/2.0/spec/service-types.html#operation) in PokemonService.
                ...
                pub enum Operation {
                    CapturePokemon,CheckHealth,DoNothing,GetServerStatistics
                }
...
/// Configuration for the [`PokemonService`]. This is the central place where to register and
            ...
            ///
            /// ```rust,no_run
            /// # use pokemon_service_protocols_aws_json_11_server_sdk::PokemonServiceConfig;
...
/// A macro to help with scoping [plugins](crate::server::plugin) to a subset of all operations.
                ...
                /// }
                ///
                /// # use pokemon_service_protocols_aws_json_11_server_sdk::server::plugin::{Plugin, Scoped};
                /// # use pokemon_service_protocols_aws_json_11_server_sdk::scope;
                /// # struct MockPlugin;
                ...
                /// # let a = Plugin::<(), pokemon_service_protocols_aws_json_11_server_sdk::operation_shape::CapturePokemon, u64>::apply(&scoped_a, 6);
                /// # let b = Plugin::<(), pokemon_service_protocols_aws_json_11_server_sdk::operation_shape::CapturePokemon, u64>::apply(&scoped_b, 6);
                /// # assert_eq!(a, 3_u32);
                /// # assert_eq!(b, 6_u64);
                /// ```
                #[macro_export]
                macro_rules! scope {
                    ...
                    (
                        ...
                        scope! { @ $ name, False ($($ include)*) () (CapturePokemon CheckHealth DoNothing GetServerStatistics) }
                    };
                    (
                        $(#[$ attrs:meta])*
                        $ vis:vis struct $ name:ident {
                        ...
                        scope! { @ $ name, True ($($ exclude)*) () (CapturePokemon CheckHealth DoNothing GetServerStatistics) }
                    };
                }
