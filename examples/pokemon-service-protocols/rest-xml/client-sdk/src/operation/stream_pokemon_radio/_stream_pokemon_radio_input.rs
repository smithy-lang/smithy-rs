...
static STREAMPOKEMONRADIOINPUT_SCHEMA: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_struct(
                            ::aws_smithy_schema::ShapeId::from_parts("com.aws.example.synthetic#StreamPokemonRadioInput", "com.aws.example.synthetic", "StreamPokemonRadioInput"),
...
impl StreamPokemonRadioInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::stream_pokemon_radio::StreamPokemonRadioInput, ::aws_smithy_types::error::operation::BuildError> {
