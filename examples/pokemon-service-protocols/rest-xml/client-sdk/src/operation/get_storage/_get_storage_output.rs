...
impl ::aws_smithy_schema::serde::SerializableStruct for GetStorageOutput {
                ...
                fn serialize_members(&self, ser: &mut dyn ::aws_smithy_schema::serde::ShapeSerializer) -> ::std::result::Result<(), ::aws_smithy_schema::serde::SerdeError> {
                    ...
                    ser.write_list(&GETSTORAGEOUTPUT_MEMBER_COLLECTION, &|ser: &mut dyn ::aws_smithy_schema::serde::ShapeSerializer| {
                        for item in val {
                ...
                pub fn deserialize(deserializer: &mut dyn ::aws_smithy_schema::serde::ShapeDeserializer) -> ::std::result::Result<Self, ::aws_smithy_schema::serde::SerdeError> {
                    ...
                    deserializer.read_struct(&GETSTORAGEOUTPUT_SCHEMA, &mut |member, deser| {
                        match member.member_index() {
                            Some(0) => { builder.collection = Some(deser.read_string_list(member)?); }
                            _ => {}
                        }
                        Ok(())
                    })?;
        ...
        ::std::result::Result::Ok(
            crate::operation::get_storage::GetStorageOutput {
                collection: self.collection
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("collection", "collection was not specified but it is required when building GetStorageOutput")
                    )?
                ,
            }
        )
