...
static GETPOKEMONSPECIESINPUT_SCHEMA: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_struct(
                            ::aws_smithy_schema::ShapeId::from_parts("com.aws.example.synthetic#GetPokemonSpeciesInput", "com.aws.example.synthetic", "GetPokemonSpeciesInput"),
...
impl GetPokemonSpeciesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_pokemon_species::GetPokemonSpeciesInput, ::aws_smithy_types::error::operation::BuildError> {
