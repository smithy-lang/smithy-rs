            ...
            "event" =>  {
                match response_headers.smithy_type.as_str() {
                    "event" =>  {
                        ...
                        Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Event(crate::types::CapturePokemonEvents::Event(builder.build())))
                    }
                    _unknown_variant =>  {
                        Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Event(crate::types::CapturePokemonEvents::Unknown))
                    }
                }
            }
            "exception" =>  {
                let generic = match crate::protocol_serde::parse_event_stream_error_metadata(message.payload()) {
                                        ...
                                        Err(err) => return Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(crate::types::error::CapturePokemonEventsError::unhandled(err))),
                                    };
                match response_headers.smithy_type.as_str() {
                "invalid_pokeball" =>  {
                    let mut err = {
                                                                let error_body = crate::protocol_serde::error_body_contents(&message.payload()[..]);
                ...
                Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(crate::types::error::CapturePokemonEventsError::generic(generic)))
            }
            value =>  {
    ...
    fn marshall(&self, _input: Self::Input) -> std::result::Result<::aws_smithy_types::event_stream::Message, ::aws_smithy_eventstream::error::Error> {
        ...
        let payload = match _input {
            crate::types::error::AttemptCapturingPokemonEventError::MasterBallUnsuccessful(inner) =>  {
                ...
                headers.push(::aws_smithy_types::event_stream::Header::new(":content-type", ::aws_smithy_types::event_stream::HeaderValue::String("application/xml".into())));
                {
                                                let codec = self.protocol.payload_codec()
