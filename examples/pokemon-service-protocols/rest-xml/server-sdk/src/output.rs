...
/// Contents of the Pokemon storage.
#[derive(::std::clone::Clone, ::std::cmp::Eq, ::std::cmp::PartialEq, ::std::fmt::Debug, ::std::hash::Hash)]
...
impl  GetStorageOutput  {
    ...
    pub fn collection(&self) -> &[::std::string::String] {
        use std::ops::Deref; self.collection.deref()
    }
}
impl  GetStorageOutput  {
...
pub mod get_pokemon_species_output {
    ...
    pub struct Builder {
        ...
        pub(crate) flavor_text_entries: ::std::option::Option<::std::vec::Vec::<crate::model::FlavorText>>,
    }
    impl  Builder  {
        /// The name for this resource.
        ...
        /// A list of flavor text entries for this Pokémon species.
        pub fn flavor_text_entries(mut self, input: ::std::vec::Vec::<crate::model::FlavorText>) -> Self {
        ...
        fn build_enforcing_all_constraints(self) -> Result<crate::output::GetPokemonSpeciesOutput , ConstraintViolation> {
            Ok(
...
pub mod get_storage_output {
    ...
    impl  Builder  {
        ...
        fn build_enforcing_all_constraints(self) -> Result<crate::output::GetStorageOutput , ConstraintViolation> {
            Ok(
