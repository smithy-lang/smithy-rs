...
pub struct StreamPokemonRadio;
            ...
            impl ::aws_smithy_http_server::operation::OperationShape for StreamPokemonRadio {
                const ID: ::aws_smithy_http_server::shape_id::ShapeId = ::aws_smithy_http_server::shape_id::ShapeId::new("com.aws.example#StreamPokemonRadio", "com.aws.example", "StreamPokemonRadio");
...
pub struct GetPokemonSpecies;
            ...
            impl ::aws_smithy_http_server::operation::OperationShape for GetPokemonSpecies {
                const ID: ::aws_smithy_http_server::shape_id::ShapeId = ::aws_smithy_http_server::shape_id::ShapeId::new("com.aws.example#GetPokemonSpecies", "com.aws.example", "GetPokemonSpecies");
...
pub struct GetStorage;
            ...
            impl ::aws_smithy_http_server::operation::OperationShape for GetStorage {
                const ID: ::aws_smithy_http_server::shape_id::ShapeId = ::aws_smithy_http_server::shape_id::ShapeId::new("com.aws.example#GetStorage", "com.aws.example", "GetStorage");
            ...
            impl ::aws_smithy_http_server::instrumentation::sensitivity::Sensitivity for GetStorage {
                type RequestFmt = ::aws_smithy_http_server::instrumentation::sensitivity::RequestFmt<
                        ::aws_smithy_http_server::instrumentation::sensitivity::headers::MakeHeaders<fn(&::http_1x::header::HeaderName) -> ::aws_smithy_http_server::instrumentation::sensitivity::headers::HeaderMarker>,
                        ::aws_smithy_http_server::instrumentation::sensitivity::uri::MakeUri<
