...
/// A request to access Pokemon storage.
...
impl  GetStorageInput  {
    ...
    pub fn passcode(&self) -> &str {
        use std::ops::Deref; self.passcode.deref()
    }
}
...
pub mod capture_pokemon_input {
    ...
    impl ::std::convert::From<ConstraintViolation> for ::aws_smithy_http_server::protocol::rest_xml::rejection::RequestRejection {
    ...
    impl  Builder  {
        ...
        #[allow(missing_docs)] // documentation missing in model
        pub(crate) fn set_region(mut self, input: impl ::std::convert::Into<::std::string::String>) -> Self {
...
pub mod get_pokemon_species_input {
    ...
    impl ::std::convert::From<Builder> for crate::constrained::MaybeConstrained<crate::input::GetPokemonSpeciesInput> {
                    fn from(builder: Builder) -> Self {
                        Self::Unconstrained(builder)
                    }
                }
    ...
    impl  Builder  {
        ...
        fn build_enforcing_all_constraints(self) -> Result<crate::input::GetPokemonSpeciesInput , ConstraintViolation> {
            Ok(
...
pub mod get_storage_input {
    ...
    impl ::std::convert::From<Builder> for crate::constrained::MaybeConstrained<crate::input::GetStorageInput> {
                    fn from(builder: Builder) -> Self {
                        Self::Unconstrained(builder)
                    }
                }
    ...
    impl  Builder  {
        ...
        #[allow(missing_docs)] // documentation missing in model
        pub(crate) fn set_user(mut self, input: impl ::std::convert::Into<::std::string::String>) -> Self {
        ...
        #[allow(missing_docs)] // documentation missing in model
        pub(crate) fn set_passcode(mut self, input: impl ::std::convert::Into<::std::string::String>) -> Self {
        ...
        fn build_enforcing_all_constraints(self) -> Result<crate::input::GetStorageInput , ConstraintViolation> {
            Ok(
