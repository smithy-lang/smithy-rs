    ...
    fn marshall(&self, _input: Self::Input) -> std::result::Result<::aws_smithy_types::event_stream::Message, ::aws_smithy_eventstream::error::Error> {
        ...
        let payload = match _input {
            crate::error::CapturePokemonEventsError::InvalidPokeballError(inner) =>  {
                headers.push(::aws_smithy_types::event_stream::Header::new(":exception-type", ::aws_smithy_types::event_stream::HeaderValue::String("invalid_pokeball".into())));
            ...
            crate::error::CapturePokemonEventsError::ThrottlingError(inner) =>  {
                headers.push(::aws_smithy_types::event_stream::Header::new(":exception-type", ::aws_smithy_types::event_stream::HeaderValue::String("throttlingError".into())));
                headers.push(::aws_smithy_types::event_stream::Header::new(":content-type", ::aws_smithy_types::event_stream::HeaderValue::String("application/xml".into())));
                ::bytes::Bytes::from(
        ...
        let payload = match input {
            Self::Input::Event(inner) =>  {
                ...
                if let Some(value) = inner.name {
                    headers.push(
                        ::aws_smithy_types::event_stream::Header::new("name", ::aws_smithy_types::event_stream::HeaderValue::String(value.into()))
                    );
                }
                if let Some(value) = inner.captured {
                    headers.push(
                        ::aws_smithy_types::event_stream::Header::new("captured", ::aws_smithy_types::event_stream::HeaderValue::Bool(value))
                    );
                }
                if let Some(value) = inner.shiny {
                    headers.push(
                        ::aws_smithy_types::event_stream::Header::new("shiny", ::aws_smithy_types::event_stream::HeaderValue::Bool(value))
                    );
                }
                ...
                match response_headers.smithy_type.as_str() {
                    "event" =>  {
                        ...
                        builder = builder.set_payload(
                            Some(
                                crate::protocol_serde::shape_capturing_event::de_payload(&message.payload()[..])
                                                    .map_err(|err| {
                                                        ::aws_smithy_eventstream::error::Error::unmarshalling(format!("failed to unmarshall payload: {err}"))
                                                    })?
                            )
                        );
                        Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Event(crate::model::AttemptCapturingPokemonEvent::Event(builder.build())))
                    }
                    _unknown_variant =>  {
                        return Err(::aws_smithy_eventstream::error::Error::unmarshalling(format!("unrecognized :event-type: {_unknown_variant}")));
                    }
                }
            }
            "exception" =>  {
                ...
                "masterball_unsuccessful"   {
                    ...
                    builder = crate::protocol_serde::shape_master_ball_unsuccessful::de_master_ball_unsuccessful_xml_err(&message.payload()[..], builder)
                                                            .map_err(|err| {
