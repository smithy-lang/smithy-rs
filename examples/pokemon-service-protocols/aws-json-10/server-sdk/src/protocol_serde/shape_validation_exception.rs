...
pub fn ser_validation_exception_error(value: &crate::error::ValidationException) -> ::std::result::Result<String, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = ::std::string::String::new();
                        let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_validation_exception::ser_validation_exception(&mut object, value)?;
    object.key("__type").string("smithy.framework#ValidationException");
    object.finish();
                        Ok(out)
}
