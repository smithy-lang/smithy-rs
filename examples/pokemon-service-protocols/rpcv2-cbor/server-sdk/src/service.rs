...
/// The service builder for [`PokemonService`].
                ...
                impl<Body, L, HttpPl, ModelPl> PokemonServiceBuilder<Body, L, HttpPl, ModelPl> {
                    ...
                    ///
                    /// ```no_run
                    /// use pokemon_service_protocols_rpcv2_cbor_server_sdk::{PokemonService, PokemonServiceConfig};
                    ///
                    /// use pokemon_service_protocols_rpcv2_cbor_server_sdk::{input, output, error};
                    ///
...
/// }
                    ...
                    ///     .build()
                    ///     .unwrap();
                    /// # let app: PokemonService<::aws_smithy_http_server::routing::RoutingService<::aws_smithy_http_server::protocol::rpc_v2_cbor::router::RpcV2CborRouter<::aws_smithy_http_server::routing::Route>, ::aws_smithy_http_server::protocol::rpc_v2_cbor::RpcV2Cbor>> = app;
                    /// ```
                    ///
...
if self.get_server_statistics.is_none() {
                        ...
                        <::aws_smithy_http_server::protocol::rpc_v2_cbor::RpcV2Cbor as ::aws_smithy_http_server::routing::RouterForOperationHandlerBindings<
...
self.get_server_statistics.expect(unexpected_error_msg)
                ...
                where
                    Body: Send + 'static,
                    L: ::tower::Layer<
                        ::aws_smithy_http_server::routing::RoutingService<::aws_smithy_http_server::protocol::rpc_v2_cbor::router::RpcV2CborRouter<::aws_smithy_http_server::routing::Route<Body>>, ::aws_smithy_http_server::protocol::rpc_v2_cbor::RpcV2Cbor>
                    >
                {
                    let svc = self
                        .layer
                        .layer(<::aws_smithy_http_server::protocol::rpc_v2_cbor::RpcV2Cbor as ::aws_smithy_http_server::routing::RouterForOperationHandlerBindings<
                                ::aws_smithy_http_server::routing::Route<Body>
                            >>::build_routing_service(
                                &crate::schema::POKEMON_SERVICE,
                                [::aws_smithy_http_server::routing::OperationHandlerBinding::new(
...
/// Configuration for the [`PokemonService`]. This is the central place where to register and
            ...
            ///
            /// ```rust,no_run
            /// # use pokemon_service_protocols_rpcv2_cbor_server_sdk::PokemonServiceConfig;
...
/// A macro to help with scoping [plugins](crate::server::plugin) to a subset of all operations.
                ...
                /// }
                ///
                /// # use pokemon_service_protocols_rpcv2_cbor_server_sdk::server::plugin::{Plugin, Scoped};
                /// # use pokemon_service_protocols_rpcv2_cbor_server_sdk::scope;
                /// # struct MockPlugin;
                ...
                /// # let a = Plugin::<(), pokemon_service_protocols_rpcv2_cbor_server_sdk::operation_shape::CapturePokemon, u64>::apply(&scoped_a, 6);
                /// # let b = Plugin::<(), pokemon_service_protocols_rpcv2_cbor_server_sdk::operation_shape::CapturePokemon, u64>::apply(&scoped_b, 6);
                /// # assert_eq!(a, 3_u32);
                /// # assert_eq!(b, 6_u64);
                /// ```
                #[macro_export]
