...
impl<Body, L, HttpPl, ModelPl> SampleServiceBuilder<Body, L, HttpPl, ModelPl> {
    ...
    pub fn sample_operation_custom<S>(mut self, svc: S) -> Self
    where
        S: ::tower::Service<
                ::http::Request<Body>,
...
///
/// ```rust,no_run
/// # use your_service_server::SampleServiceConfig;
...
/// }
///
/// # use your_service_server::server::plugin::{Plugin, Scoped};
/// # use your_service_server::scope;
/// # struct MockPlugin;
...
/// # let a = Plugin::<(), your_service_server::operation_shape::SampleOperation, u64>::apply(&scoped_a, 6);
/// # let b = Plugin::<(), your_service_server::operation_shape::SampleOperation, u64>::apply(&scoped_b, 6);
/// # assert_eq!(a, 3_u32);
/// # assert_eq!(b, 6_u64);
/// ```
#[macro_export]
