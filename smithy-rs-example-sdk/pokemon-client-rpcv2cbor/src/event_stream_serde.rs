...
pub(crate) fn initial_message_from_body(body: ::aws_smithy_types::body::SdkBody) -> ::aws_smithy_types::event_stream::Message {
    let mut headers = ::std::vec::Vec::with_capacity(3);
    headers.push(::aws_smithy_types::event_stream::Header::new(
        ":message-type",
        ::aws_smithy_types::event_stream::HeaderValue::String("event".into()),
    ));
    headers.push(::aws_smithy_types::event_stream::Header::new(
        ":event-type",
        ::aws_smithy_types::event_stream::HeaderValue::String("initial-request".into()),
    ));
    headers.push(::aws_smithy_types::event_stream::Header::new(
        ":content-type",
    ...
    ::aws_smithy_types::event_stream::Message::new_from_parts(headers, body)
}
