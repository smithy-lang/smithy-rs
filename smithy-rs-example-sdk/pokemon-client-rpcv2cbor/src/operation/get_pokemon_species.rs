...
impl GetPokemonSpecies {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_pokemon_species::GetPokemonSpeciesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_pokemon_species::GetPokemonSpeciesOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("PokemonService", "GetPokemonSpecies", input, runtime_plugins, stop_point)
    ...
    fn serialize_input(
        ...
        if _required_check.is_empty() {
            return ::std::result::Result::Err(
                ::aws_smithy_types::error::operation::BuildError::missing_field("name", "cannot be empty or unset").into(),
            );
        }
        let protocol = _cfg
            .load::<::aws_smithy_schema::protocol::SharedClientProtocol>()
