...
impl DoNothing {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::do_nothing::DoNothingError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::do_nothing::DoNothingOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("PokemonService", "DoNothing", input, runtime_plugins, stop_point)
