...
val workingDirUnderBuildDir = "smithyprojections/smithy-rust-codegen-server-test-typescript/"
...
dependencies {
    implementation(project(":smithy-rust-codegen-server-typescript"))
    implementation("software.amazon.smithy:smithy-aws-protocol-tests:$smithyVersion")
    implementation("software.amazon.smithy:smithy-protocol-test-traits:$smithyVersion")
    implementation("software.amazon.smithy:smithy-aws-traits:$smithyVersion")
}

val allCodegenTests = "../smithy-rust-codegen-core/common-test-models".let { commonModels ->
    listOf(
