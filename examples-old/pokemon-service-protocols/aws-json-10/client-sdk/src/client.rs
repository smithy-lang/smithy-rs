...
///
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), pokemon_service_protocols_aws_json_10_client_sdk::Error> {
/// # let client: pokemon_service_protocols_aws_json_10_client_sdk::Client = unimplemented!();
