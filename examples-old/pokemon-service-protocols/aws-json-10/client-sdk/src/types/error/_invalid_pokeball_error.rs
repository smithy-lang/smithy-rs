...
static INVALIDPOKEBALLERROR_MEMBER_MESSAGE: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
                            ::aws_smithy_schema::ShapeId::from_parts(
                                "com.aws.example#InvalidPokeballError$Message",
                                "com.aws.example",
                                "InvalidPokeballError",
                            ),
                            ::aws_smithy_schema::ShapeType::String,
                ...
                pub fn deserialize(deserializer: &mut dyn ::aws_smithy_schema::serde::ShapeDeserializer) -> ::std::result::Result<Self, ::aws_smithy_schema::serde::SerdeError> {
                    ...
                    deserializer.read_struct(&INVALIDPOKEBALLERROR_SCHEMA, &mut |member, deser| {
                        match member.member_index() {
                            Some(0) => { builder.pokeball = Some(deser.read_string(member)?); }
Some(1) => {
...
impl InvalidPokeballErrorBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::error::InvalidPokeballError, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::error::InvalidPokeballError {
                pokeball: self.pokeball
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("pokeball", "pokeball was not specified but it is required when building InvalidPokeballError")
                    )?
                ,
