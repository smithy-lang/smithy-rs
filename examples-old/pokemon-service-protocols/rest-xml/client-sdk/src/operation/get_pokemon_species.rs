...
impl GetPokemonSpecies {
    ...
    /// The schema for this operation's input shape.
                        pub const INPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = crate::operation::get_pokemon_species::GetPokemonSpeciesInput::SCHEMA;
                        /// The schema for this operation's output shape.
                        pub const OUTPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = crate::operation::get_pokemon_species::GetPokemonSpeciesOutput::SCHEMA;
    pub(crate) async fn orchestrate(
                        runtime_plugins: &::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugins,
                        input: crate::operation::get_pokemon_species::GetPokemonSpeciesInput,
                    ) -> ::std::result::Result<crate::operation::get_pokemon_species::GetPokemonSpeciesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_pokemon_species::GetPokemonSpeciesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_pokemon_species::GetPokemonSpeciesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_pokemon_species::GetPokemonSpeciesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetPokemonSpecies {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    ...
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetPokemonSpeciesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetPokemonSpeciesResponseDeserializer));
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ...
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetPokemonSpecies")
                            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(GetPokemonSpeciesTelemetryInputCaptureInterceptor))
...
.with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(GetPokemonSpeciesEndpointParamsInterceptor))
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_pokemon_species::GetPokemonSpeciesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_pokemon_species::GetPokemonSpeciesError>::new());
            ...
            #[derive(Debug)]
            struct GetPokemonSpeciesTelemetryInputCaptureInterceptor;

            #[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetPokemonSpeciesTelemetryInputCaptureInterceptor {
                fn name(&self) -> &'static str {
                    "GetPokemonSpeciesTelemetryInputCaptureInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetPokemonSpeciesInput>() else {
...
let error_code = match generic.code() {
                    ...
                    ::std::option::Option::None => return ::std::result::Result::Err(::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(::aws_smithy_runtime_api::box_error::BoxError::from(crate::operation::get_pokemon_species::GetPokemonSpeciesError::unhandled(generic)))),
                };
...
let mut tmp = match protocol.deserialize_error_response(response, _cfg)
                        .and_then(|mut deser| crate::types::error::ResourceNotFoundError::deserialize_with_response(&mut *deser, response.headers(), response.status().into(), body))
                    {
...
_ => {
                    ...
                    match protocol
                        ...
                        .and_then(|mut deser| {
                            ::aws_smithy_schema::registry::reify_error(
                                crate::operation::get_pokemon_species::error_registry::REGISTRY
                                    .or(&crate::error_type_registry::REGISTRY),
                                error_code,
                                &mut *deser,
                            )
                        }) {
                        ::std::option::Option::Some(source) => <crate::operation::get_pokemon_species::GetPokemonSpeciesError as ::aws_smithy_runtime_api::client::result::CreateUnhandledError>::create_unhandled_error(source, ::std::option::Option::Some(generic)),
                        ::std::option::Option::None => crate::operation::get_pokemon_species::GetPokemonSpeciesError::generic(generic),
                    }
                }
};
                ...
                let protocol = _cfg.load::<::aws_smithy_schema::protocol::SharedClientProtocol>()
                    .expect("a SharedClientProtocol is required");
                let mut deser = protocol.deserialize_response(response, GetPokemonSpecies::OUTPUT_SCHEMA, _cfg)
                    .map_err(|e| ::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(::aws_smithy_runtime_api::box_error::BoxError::from(e)))?;
                ...
                #[allow(unused_mut)]
                let mut output = crate::operation::get_pokemon_species::GetPokemonSpeciesOutput::deserialize_with_response(
                    &mut *deser,
                    _response_headers,
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetPokemonSpeciesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_pokemon_species::GetPokemonSpeciesInput>().expect("correct type");
                    let _required_check = input.name.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("name", "cannot be empty or unset"))?;
if _required_check.is_empty() {
    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("name", "cannot be empty or unset").into());
}
                    let protocol = _cfg.load::<::aws_smithy_schema::protocol::SharedClientProtocol>()
                        .expect("a SharedClientProtocol is required");
                    let mut request = protocol.serialize_request(
                        &input, GetPokemonSpecies::INPUT_SCHEMA, "", _cfg,
