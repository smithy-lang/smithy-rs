...
impl DoNothing {
    ...
    /// The schema for this operation's input shape.
                        pub const INPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = crate::operation::do_nothing::DoNothingInput::SCHEMA;
                        /// The schema for this operation's output shape.
                        pub const OUTPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = crate::operation::do_nothing::DoNothingOutput::SCHEMA;
    pub(crate) async fn orchestrate(
                        runtime_plugins: &::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugins,
                        input: crate::operation::do_nothing::DoNothingInput,
                    ) -> ::std::result::Result<crate::operation::do_nothing::DoNothingOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::do_nothing::DoNothingError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::do_nothing::DoNothingError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::do_nothing::DoNothingOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DoNothing {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    ...
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DoNothingRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DoNothingResponseDeserializer));

                    cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
                        crate::config::auth::Params::builder()
                            .operation_name("DoNothing")
                            .build()
...
.with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(DoNothingEndpointParamsInterceptor))
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::do_nothing::DoNothingError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::do_nothing::DoNothingError>::new());
...
::std::result::Result::Err(::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::operation(::aws_smithy_runtime_api::client::interceptors::context::Error::erase(crate::operation::do_nothing::DoNothingError::generic(generic))))
} else {
                let protocol = _cfg.load::<::aws_smithy_schema::protocol::SharedClientProtocol>()
                    .expect("a SharedClientProtocol is required");
                let mut deser = protocol.deserialize_response(response, DoNothing::OUTPUT_SCHEMA, _cfg)
                    .map_err(|e| ::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(::aws_smithy_runtime_api::box_error::BoxError::from(e)))?;
                ...
                #[allow(unused_mut)]
                let mut output = crate::operation::do_nothing::DoNothingOutput::deserialize_with_response(
                    &mut *deser,
                    _response_headers,
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DoNothingRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    ...
                    let mut request = protocol.serialize_request(
                        &input, DoNothing::INPUT_SCHEMA, "", _cfg,
