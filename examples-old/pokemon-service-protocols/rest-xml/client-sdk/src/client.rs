...
///
/// An ergonomic client for Pokemon Service.
///
/// This client allows ergonomic access to Pokemon Service.
/// Each method corresponds to an API defined in the service's Smithy model,
/// and the request and response shapes are auto-generated from that same model.
///
/// Client for calling Pokemon Service.
///
...
///
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), pokemon_service_protocols_rest_xml_client_sdk::Error> {
/// # let client: pokemon_service_protocols_rest_xml_client_sdk::Client = unimplemented!();
