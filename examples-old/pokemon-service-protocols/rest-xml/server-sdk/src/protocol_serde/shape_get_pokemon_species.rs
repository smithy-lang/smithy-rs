...
where
    ...
    Ok({
        ...
        input = input.set_name(
                                    crate::protocol_serde::shape_get_pokemon_species_input::de_name(m1)?
                                );
        input.build()?
    })
}
...
> {
    Ok({
        ...
        let payload =
            crate::protocol_serde::shape_get_pokemon_species::ser_get_pokemon_species_output(&output)?
        ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn ser_get_pokemon_species_http_error(error: &crate::error::GetPokemonSpeciesError) -> std::result::Result<::aws_smithy_http_server::response::Response, ::aws_smithy_http_server::protocol::rest_xml::rejection::ResponseRejection> {
    Ok({
        match error {
...
pub fn ser_get_pokemon_species_output(output: &crate::output::GetPokemonSpeciesOutput) -> ::std::result::Result<String, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
     {
        let mut writer = ::aws_smithy_xml::encode::XmlWriter::new(&mut out);
                                #[allow(unused_mut)]
                                let mut root = writer.start_el("GetPokemonSpeciesOutput");
        crate::protocol_serde::shape_get_pokemon_species_output::ser_get_pokemon_species_output_output(output, root)?
    }
    Ok(out)
}
