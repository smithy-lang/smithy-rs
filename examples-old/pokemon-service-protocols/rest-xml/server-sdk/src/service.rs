...
/// The service builder for [`PokemonService`].
                ...
                pub struct PokemonServiceBuilder<Body, L, HttpPl, ModelPl> {
                    capture_pokemon: Option<::aws_smithy_http_server::routing::Route<Body>>, check_health: Option<::aws_smithy_http_server::routing::Route<Body>>, do_nothing: Option<::aws_smithy_http_server::routing::Route<Body>>, get_pokemon_species: Option<::aws_smithy_http_server::routing::Route<Body>>, get_server_statistics: Option<::aws_smithy_http_server::routing::Route<Body>>, get_storage: Option<::aws_smithy_http_server::routing::Route<Body>>, stream_pokemon_radio: Option<::aws_smithy_http_server::routing::Route<Body>>,
                    layer: L,
                    http_plugin: HttpPl,
                ...
                impl<Body, L, HttpPl, ModelPl> PokemonServiceBuilder<Body, L, HttpPl, ModelPl> {
                    ...
                    ///
                    /// ```no_run
                    /// use pokemon_service_protocols_rest_xml_server_sdk::{PokemonService, PokemonServiceConfig};
                    ///
                    /// use pokemon_service_protocols_rest_xml_server_sdk::{input, output, error};
                    ///
...
/// }
                    ...
                    ///     .build()
                    ///     .unwrap();
                    /// # let app: PokemonService<::aws_smithy_http_server::routing::RoutingService<::aws_smithy_http_server::protocol::rest::router::RestRouter<::aws_smithy_http_server::routing::Route>, ::aws_smithy_http_server::protocol::rest_xml::RestXml>> = app;
                    /// ```
                    ///
...
/// }
                    ...
                    where
                        S: ::tower::Service<::http_1x::Request<Body>, Response = ::http_1x::Response<::aws_smithy_http_server::body::BoxBody>, Error = ::std::convert::Infallible> + Clone + Send + 'static,
                    ...
                    L: ::tower::Layer<::aws_smithy_http_server::routing::Route<Body>>,
                {
                    let svc = {
                        ...
                        if self.capture_pokemon.is_none() {
                                missing_operation_names.insert(crate::operation_shape::CapturePokemon::ID, ".capture_pokemon()");
                            }
if self.check_health.is_none() {
                                missing_operation_names.insert(crate::operation_shape::CheckHealth::ID, ".check_health()");
                            }
...
if self.get_pokemon_species.is_none() {
                                missing_operation_names.insert(crate::operation_shape::GetPokemonSpecies::ID, ".get_pokemon_species()");
                            }
...
if self.get_storage.is_none() {
                                missing_operation_names.insert(crate::operation_shape::GetStorage::ID, ".get_storage()");
                            }
if self.stream_pokemon_radio.is_none() {
                                missing_operation_names.insert(crate::operation_shape::StreamPokemonRadio::ID, ".stream_pokemon_radio()");
                            }
                        ...
                        <::aws_smithy_http_server::protocol::rest_xml::RestXml as ::aws_smithy_http_server::routing::RouterForOperationHandlerBindings<
...
self.stream_pokemon_radio.expect(unexpected_error_msg)
                ...
                where
                    Body: Send + 'static,
                    L: ::tower::Layer<
                        ::aws_smithy_http_server::routing::RoutingService<::aws_smithy_http_server::protocol::rest::router::RestRouter<::aws_smithy_http_server::routing::Route<Body>>, ::aws_smithy_http_server::protocol::rest_xml::RestXml>
                    >
                {
                    let svc = self
                        .layer
                        .layer(<::aws_smithy_http_server::protocol::rest_xml::RestXml as ::aws_smithy_http_server::routing::RouterForOperationHandlerBindings<
                                ::aws_smithy_http_server::routing::Route<Body>
                            >>::build_routing_service(
                                &crate::schema::POKEMON_SERVICE,
                                [::aws_smithy_http_server::routing::OperationHandlerBinding::new(
...
, stream_pokemon_radio: None,
            ...
            /// An enumeration of all [operations](https://smithy.io/2.0/spec/service-types.html#operation) in PokemonService.
                ...
                pub enum Operation {
                    CapturePokemon,CheckHealth,DoNothing,GetPokemonSpecies,GetServerStatistics,GetStorage,StreamPokemonRadio
                }
                ...
                impl Operation {
                    ...
                    pub fn shape_id(&self) -> ::aws_smithy_http_server::shape_id::ShapeId {
                        match self {
                            Operation::CapturePokemon => ::aws_smithy_http_server::shape_id::ShapeId::new("com.aws.example#CapturePokemon", "com.aws.example", "CapturePokemon")
,Operation::CheckHealth => ::aws_smithy_http_server::shape_id::ShapeId::new("com.aws.example#CheckHealth", "com.aws.example", "CheckHealth")
,Operation::DoNothing => ::aws_smithy_http_server::shape_id::ShapeId::new("com.aws.example#DoNothing", "com.aws.example", "DoNothing")
,Operation::GetPokemonSpecies => ::aws_smithy_http_server::shape_id::ShapeId::new("com.aws.example#GetPokemonSpecies", "com.aws.example", "GetPokemonSpecies")
...
,Operation::GetStorage => ::aws_smithy_http_server::shape_id::ShapeId::new("com.aws.example#GetStorage", "com.aws.example", "GetStorage")
,Operation::StreamPokemonRadio => ::aws_smithy_http_server::shape_id::ShapeId::new("com.aws.example#StreamPokemonRadio", "com.aws.example", "StreamPokemonRadio")
                        }
                    }
                }
...
impl<L> ::aws_smithy_http_server::service::ContainsOperation<crate::operation_shape::GetPokemonSpecies>
                        for PokemonService<L>
                    {
...
impl<L> ::aws_smithy_http_server::service::ContainsOperation<crate::operation_shape::StreamPokemonRadio>
                        for PokemonService<L>
                    {
...
/// Configuration for the [`PokemonService`]. This is the central place where to register and
            ...
            ///
            /// ```rust,no_run
            /// # use pokemon_service_protocols_rest_xml_server_sdk::PokemonServiceConfig;
...
/// A macro to help with scoping [plugins](crate::server::plugin) to a subset of all operations.
                ...
                /// }
                ///
                /// # use pokemon_service_protocols_rest_xml_server_sdk::server::plugin::{Plugin, Scoped};
                /// # use pokemon_service_protocols_rest_xml_server_sdk::scope;
                /// # struct MockPlugin;
                ...
                /// # let a = Plugin::<(), pokemon_service_protocols_rest_xml_server_sdk::operation_shape::CapturePokemon, u64>::apply(&scoped_a, 6);
                /// # let b = Plugin::<(), pokemon_service_protocols_rest_xml_server_sdk::operation_shape::CapturePokemon, u64>::apply(&scoped_b, 6);
                /// # assert_eq!(a, 3_u32);
                /// # assert_eq!(b, 6_u64);
                /// ```
                #[macro_export]
