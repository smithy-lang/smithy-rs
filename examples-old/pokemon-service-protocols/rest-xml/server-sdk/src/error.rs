...
impl ::std::convert::From<crate::error::ResourceNotFoundException> for crate::error::GetPokemonSpeciesError {
...
impl ::std::convert::From<crate::error::ValidationException> for crate::error::GetPokemonSpeciesError {
...
impl ::std::convert::From<crate::error::StorageAccessNotAuthorized> for crate::error::GetStorageError {
...
pub mod resource_not_found_exception {
    ...
    impl  Builder  {
        ...
        fn build_enforcing_all_constraints(self) -> Result<crate::error::ResourceNotFoundException , ConstraintViolation> {
            Ok(
