...
impl GetServerStatisticsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_server_statistics::GetServerStatisticsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_server_statistics::GetServerStatisticsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_server_statistics::GetServerStatisticsOutput, crate::operation::get_server_statistics::GetServerStatisticsError, Self> {
