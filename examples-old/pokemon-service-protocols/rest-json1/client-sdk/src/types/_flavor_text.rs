                ...
                pub fn deserialize(deserializer: &mut dyn ::aws_smithy_schema::serde::ShapeDeserializer) -> ::std::result::Result<Self, ::aws_smithy_schema::serde::SerdeError> {
                    ...
                    deserializer.read_struct(&FLAVORTEXT_SCHEMA, &mut |member, deser| {
                        match member.member_index() {
                            Some(0) => { builder.flavor_text = Some(deser.read_string(member)?); }
Some(1) => { builder.language = Some(crate::types::Language::from(deser.read_string(member)?.as_str())); }
                            _ => {}
                        }
                        Ok(())
                    })?;
...
impl FlavorTextBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::FlavorText, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::FlavorText {
                flavor_text: self.flavor_text
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("flavor_text", "flavor_text was not specified but it is required when building FlavorText")
                    )?
                ,
                language: self.language
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("language", "language was not specified but it is required when building FlavorText")
                    )?
                ,
            }
        )
