...
impl AttemptCapturingPokemonEvent {
    ...
    pub fn as_event(&self) -> ::std::result::Result<&crate::model::CapturingEvent, &Self> {
        if let AttemptCapturingPokemonEvent::Event(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
...
impl CapturePokemonEvents {
    ...
    pub fn as_event(&self) -> ::std::result::Result<&crate::model::CaptureEvent, &Self> {
        if let CapturePokemonEvents::Event(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
...
impl  FlavorText  {
    ...
    pub fn flavor_text(&self) -> &str {
        use std::ops::Deref; self.flavor_text.deref()
    }
    /// The language this name is in.
    ...
    #[derive(Debug, PartialEq)]
                    ...
                    impl ::std::fmt::Display for ConstraintViolation {
                        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                            write!(f, r#"Value provided for 'com.aws.example#Language' failed to satisfy constraint: Member must satisfy enum value set: [en, es, it, jp]"#)
                        }
                    }
...
impl crate::constrained::Constrained for Language  {
            ...
            impl ::std::convert::From<::std::string::String> for crate::constrained::MaybeConstrained<crate::model::Language> {
...
pub mod capturing_event {
    ...
    impl  Builder  {
        #[allow(missing_docs)] // documentation missing in model
        pub fn payload(mut self, input: ::std::option::Option<crate::model::CapturingPayload>) -> Self {
            self.payload =
                input
            ; self
        }
        #[allow(missing_docs)] // documentation missing in model
        pub(crate) fn set_payload(mut self, input: Option<impl ::std::convert::Into<crate::model::CapturingPayload>>) -> Self {
...
pub mod capture_event {
    ...
    impl  Builder  {
        ...
        #[allow(missing_docs)] // documentation missing in model
        pub fn pokedex_update(mut self, input: ::std::option::Option<::aws_smithy_types::Blob>) -> Self {
            self.pokedex_update =
                input
            ; self
        }
...
pub mod flavor_text {
    ...
    impl ::std::fmt::Display for ConstraintViolation {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            match self {
                ConstraintViolation::MissingFlavorText => write!(f, "`flavor_text` was not provided but it is required when building `FlavorText`"),
                ConstraintViolation::MissingLanguage => write!(f, "`language` was not provided but it is required when building `FlavorText`"),
            }
        }
    }
    impl ::std::error::Error for ConstraintViolation { }
    ...
    impl  Builder  {
        ...
        fn build_enforcing_all_constraints(self) -> Result<crate::model::FlavorText , ConstraintViolation> {
            Ok(
...
pub mod capturing_payload {
    ...
    impl  Builder  {
        ...
        #[allow(missing_docs)] // documentation missing in model
        pub(crate) fn set_pokeball(mut self, input: Option<impl ::std::convert::Into<::std::string::String>>) -> Self {
