...
///
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), pokemon_service_protocols_rpcv2_cbor_client_sdk::Error> {
/// # let client: pokemon_service_protocols_rpcv2_cbor_client_sdk::Client = unimplemented!();
