...
/// Configuration for a pokemon_service_protocols_aws_json_11_client_sdk service client.
///
...
impl Builder {
    ...
    /// Sets the HTTP client to use when making requests.
                            ...
                            /// use pokemon_service_protocols_aws_json_11_client_sdk::config::Config;
                            ...
                            /// # fn example() {
                            /// use std::time::Duration;
                            /// use pokemon_service_protocols_aws_json_11_client_sdk::config::{Builder, Config};
                            /// use aws_smithy_runtime::client::http::hyper_014::HyperClientBuilder;
                            ///
                            ...
                            /// }
                            ///
                            /// let mut builder = pokemon_service_protocols_aws_json_11_client_sdk::Config::builder();
    ...
    /// Adds an auth scheme to the builder
                            ...
                            /// impl pokemon_service_protocols_aws_json_11_client_sdk::config::auth::ResolveAuthScheme for CustomAuthSchemeResolver {
                            ///     fn resolve_auth_scheme<'a>(
                            ///         &'a self,
                            ///         _params: &'a pokemon_service_protocols_aws_json_11_client_sdk::config::auth::Params,
                            ///         _cfg: &'a ConfigBag,
                            ///         _runtime_components: &'a RuntimeComponents,
                            ...
                            /// }
                            ///
                            /// let config = pokemon_service_protocols_aws_json_11_client_sdk::Config::builder()
    ...
    /// Set the auth scheme preference for an auth scheme resolver
                            ...
                            ///     // ...
                            ///     .build();
                            /// let client = pokemon_service_protocols_aws_json_11_client_sdk::Client::from_conf(config);
                            /// ```
    ...
    /// Sets the endpoint resolver to use when making requests.
                            ...
                            /// ```no_run
                            /// use pokemon_service_protocols_aws_json_11_client_sdk::config::endpoint::{ResolveEndpoint, EndpointFuture, Params, Endpoint};
                            /// #[derive(Debug)]
                            ...
                            /// let config = pokemon_service_protocols_aws_json_11_client_sdk::Config::builder().endpoint_resolver(resolver).build();
                            /// let client = pokemon_service_protocols_aws_json_11_client_sdk::Client::from_conf(config);
                            /// ```
    ...
    /// Set the retry_config for the builder
                            ...
                            /// ```no_run
                            /// use pokemon_service_protocols_aws_json_11_client_sdk::config::Config;
                            /// use pokemon_service_protocols_aws_json_11_client_sdk::config::retry::RetryConfig;
                            ///
    ...
    /// Set the sleep_impl for the builder
                            ...
                            ///
                            /// ```no_run
                            /// use pokemon_service_protocols_aws_json_11_client_sdk::config::{AsyncSleep, Config, SharedAsyncSleep, Sleep};
                            ///
                            /// #[derive(Debug)]
                            ...
                            ///
                            /// ```no_run
                            /// use pokemon_service_protocols_aws_json_11_client_sdk::config::{AsyncSleep, Builder, Config, SharedAsyncSleep, Sleep};
                            ///
                            /// #[derive(Debug)]
                            /// pub struct ForeverSleep;
                            ///
    ...
    /// Set the timeout_config for the builder
                            ...
                            /// # use std::time::Duration;
                            /// use pokemon_service_protocols_aws_json_11_client_sdk::config::Config;
                            /// use pokemon_service_protocols_aws_json_11_client_sdk::config::timeout::TimeoutConfig;
                            ///
    ...
    /// Set the partition for retry-related state. When clients share a retry partition, they will
                            ...
                            /// ```no_run
                            /// use pokemon_service_protocols_aws_json_11_client_sdk::config::Config;
                            /// use pokemon_service_protocols_aws_json_11_client_sdk::config::retry::{RetryPartition, TokenBucket};
                            ///
                            ...
                            /// ```no_run
                            /// use pokemon_service_protocols_aws_json_11_client_sdk::config::Config;
                            /// use pokemon_service_protocols_aws_json_11_client_sdk::config::retry::{ClientRateLimiter, RetryConfig, RetryPartition};
                            ///
    ...
    /// Set the identity cache for auth.
                            ...
                            /// ```no_run
                            /// use pokemon_service_protocols_aws_json_11_client_sdk::config::IdentityCache;
                            ///
                            /// let config = pokemon_service_protocols_aws_json_11_client_sdk::Config::builder()
    ...
    /// Add type implementing [`ClassifyRetry`](::aws_smithy_runtime_api::client::retries::classifiers::ClassifyRetry) that will be used by the
                            ...
                            /// #    fn meta(&self) -> &pokemon_service_protocols_aws_json_11_client_sdk::error::ErrorMetadata { todo!() }
                            /// # }
                            ///
    ...
    /// Sets the [`behavior major version`](crate::config::BehaviorVersion).
                    ...
                    /// ```no_run
                    /// use pokemon_service_protocols_aws_json_11_client_sdk::config::BehaviorVersion;
                    ///
                    /// let config = pokemon_service_protocols_aws_json_11_client_sdk::Config::builder()
    ...
    pub fn build(mut self) -> Config {
        ...
        Config {
            config: crate::config::Layer::from(layer.clone()).with_name("pokemon_service_protocols_aws_json_11_client_sdk::config::Config").freeze(),
                                    cloneable: layer,
...
if _service_config.protocol().is_none() {
                            cfg.store_put(
                                ::aws_smithy_schema::protocol::SharedClientProtocol::new(::aws_smithy_json::protocol::aws_json_rpc::AwsJsonRpcProtocol::aws_json_1_1().with_default_namespace("com.aws.example"))
                            );
                        }
                ...
                pub(crate) fn new(
                    ...
                    Self {
                        config: ::aws_smithy_types::config_bag::Layer::from(layer)
                            .with_name("pokemon_service_protocols_aws_json_11_client_sdk::config::ConfigOverrideRuntimePlugin").freeze(),
                        components,
                    }
                }
            }
...
pub(crate) fn base_client_runtime_plugins(
    ...
    if config.behavior_version.is_none() {
                    ...
                    let scope = "pokemon-service-protocols-aws-json-11-client-sdk";
