...
//! use pokemon_service_protocols_aws_json_10_standard_server_sdk::serve;
...
//!
//! ```rust,ignore
//! use pokemon_service_protocols_aws_json_10_standard_server_sdk::server::routing::LambdaHandler;
//! use pokemon_service_protocols_aws_json_10_standard_server_sdk::PokemonService;
//!
//! # async fn dummy() {
//! # let app = PokemonService::builder(
//! #     PokemonServiceConfig::builder()
...
//!
//! ```rust,no_run
//! # use pokemon_service_protocols_aws_json_10_standard_server_sdk::server::plugin::IdentityPlugin as LoggingPlugin;
//! # use pokemon_service_protocols_aws_json_10_standard_server_sdk::server::plugin::IdentityPlugin as MetricsPlugin;
//! # use ::hyper::body::Incoming;
//! use pokemon_service_protocols_aws_json_10_standard_server_sdk::server::plugin::HttpPlugins;
//! use pokemon_service_protocols_aws_json_10_standard_server_sdk::{PokemonService, PokemonServiceConfig, PokemonServiceBuilder};
//!
...
//! # struct State;
//! # use std::net::SocketAddr;
//! use pokemon_service_protocols_aws_json_10_standard_server_sdk::server::request::{extension::Extension, connect_info::ConnectInfo};
//!
