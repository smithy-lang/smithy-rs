    ...
    > {
        ...
        let payload = match _input {
            crate::error::CapturePokemonEventsError::InvalidPokeballError(inner) => {
                ...
                headers.push(::aws_smithy_types::event_stream::Header::new(
                    ":content-type",
                    ::aws_smithy_types::event_stream::HeaderValue::String("application/xml".into()),
                ));
                ::bytes::Bytes::from(
            ...
            "event" => match response_headers.smithy_type.as_str() {
                "event" => {
                    ...
                    builder = builder.set_payload(Some(
                        crate::protocol_serde::shape_capturing_event::de_payload(
                            &message.payload()[..],
                        )
                        .map_err(|err| {
                            ::aws_smithy_eventstream::error::Error::unmarshalling(format!(
                                "failed to unmarshall payload: {err}"
                            ))
                        })?,
                    ));
