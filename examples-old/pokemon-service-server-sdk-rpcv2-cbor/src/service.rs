...
impl<Body, L, HttpPl, ModelPl> PokemonServiceBuilder<Body, L, HttpPl, ModelPl> {
    ...
    ///
    /// ```no_run
    /// use pokemon_service_protocols_rpcv2_cbor_standard_server_sdk::{PokemonService, PokemonServiceConfig};
    ///
    /// use pokemon_service_protocols_rpcv2_cbor_standard_server_sdk::{input, output, error};
    ///
...
///
/// ```rust,no_run
/// # use pokemon_service_protocols_rpcv2_cbor_standard_server_sdk::PokemonServiceConfig;
...
/// }
///
/// # use pokemon_service_protocols_rpcv2_cbor_standard_server_sdk::server::plugin::{Plugin, Scoped};
/// # use pokemon_service_protocols_rpcv2_cbor_standard_server_sdk::scope;
/// # struct MockPlugin;
...
/// # let a = Plugin::<(), pokemon_service_protocols_rpcv2_cbor_standard_server_sdk::operation_shape::CapturePokemon, u64>::apply(&scoped_a, 6);
/// # let b = Plugin::<(), pokemon_service_protocols_rpcv2_cbor_standard_server_sdk::operation_shape::CapturePokemon, u64>::apply(&scoped_b, 6);
/// # assert_eq!(a, 3_u32);
/// # assert_eq!(b, 6_u64);
/// ```
#[macro_export]
