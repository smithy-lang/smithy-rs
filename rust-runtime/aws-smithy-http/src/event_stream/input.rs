...
pin_project! {
    #[doc = "Adapts a `Stream<SmithyMessageType>` to a signed `Stream<Bytes>` by using the provided"]
    #[doc = "message marshaller and signer implementations."]
    #[doc = ""]
    #[doc = "This will yield an `Err(SdkError::ConstructionFailure)` if a message can't be"]
    #[doc = "marshalled into an Event Stream frame, (e.g., if the message payload was too large)."]
