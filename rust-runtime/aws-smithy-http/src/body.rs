...
pin_project! {
    #[doc = "SdkBody type"]
    #[doc = ""]
    #[doc = "This is the Body used for dispatching all HTTP Requests."]
    #[doc = "For handling responses, the type of the body will be controlled"]
    #[doc = "by the HTTP stack."]
    #[doc = ""]
    #[doc = "TODO(naming): Consider renaming to simply `Body`, although I'm concerned about naming headaches"]
    #[doc = "between hyper::Body and our Body"]
    pub struct SdkBody {
        #[pin]
        inner: Inner,
