...
pin_project! {
    ...
    #[doc = "       let data = stream.collect().await.expect(\"error reading data\");"]
    #[doc = "       // collect returns a `bytes::Buf`:"]
    #[doc = "       println!(\"first chunk: {:?}\", data.chunk());"]
    #[doc = "    }"]
    #[doc = "    ```"]
    #[doc = "2. Via [`impl Stream`](futures_core::Stream):"]
    #[doc = ""]
    #[doc = "    _Note: An import of `StreamExt` is required to use `.try_next()`._"]
    #[doc = ""]
    #[doc = "    For use-cases where holding the entire ByteStream in memory is unnecessary, use the"]
    #[doc = "    `Stream` implementation:"]
    #[doc = "    ```no_run"]
    #[doc = "    # mod crc32 {"]
    #[doc = "    #   pub struct Digest { }"]
    #[doc = "    #   impl Digest {"]
    #[doc = "    #       pub fn new() -> Self { Digest {} }"]
    #[doc = "    #       pub fn write(&mut self, b: &[u8]) { }"]
    #[doc = "    #       pub fn finish(&self) -> u64 { 6 }"]
    #[doc = "    #   }"]
    #[doc = "    # }"]
    #[doc = "    use aws_smithy_http::byte_stream::{ByteStream, AggregatedBytes, Error};"]
    #[doc = "    use aws_smithy_http::body::SdkBody;"]
    #[doc = "    use tokio_stream::StreamExt;"]
    #[doc = ""]
    #[doc = "    async fn example() -> Result<(), Error> {"]
    #[doc = "       let mut stream = ByteStream::from(vec![1, 2, 3, 4, 5, 99]);"]
    #[doc = "       let mut digest = crc32::Digest::new();"]
    #[doc = "       while let Some(bytes) = stream.try_next().await? {"]
    #[doc = "           digest.write(&bytes);"]
    #[doc = "       }"]
    #[doc = "       println!(\"digest: {}\", digest.finish());"]
    #[doc = "       Ok(())"]
    #[doc = "    }"]
    #[doc = "    ```"]
    #[doc = ""]
    #[doc = "3. Via [`.into_async_read()`](crate::byte_stream::ByteStream::into_async_read):"]
    #[doc = ""]
    #[doc = "    _Note: The `rt-tokio` feature must be active to use `.into_async_read()`._"]
    #[doc = ""]
    #[doc = "    It's possible to convert a `ByteStream` into a struct that implements [`tokio::io::AsyncRead`](tokio::io::AsyncRead)."]
    #[doc = "    Then, you can use pre-existing tools like [`tokio::io::BufReader`](tokio::io::BufReader):"]
    #[doc = "    ```no_run"]
    #[doc = "    use aws_smithy_http::byte_stream::ByteStream;"]
    #[doc = "    use aws_smithy_http::body::SdkBody;"]
    #[doc = "    use tokio::io::{AsyncBufReadExt, BufReader};"]
    #[doc = "    #[cfg(feature = \"rt-tokio\")]"]
    #[doc = "    async fn example() -> std::io::Result<()> {"]
    #[doc = "        let stream = ByteStream::new(SdkBody::from(\"hello!\\nThis is some data\"));"]
    #[doc = "        // Wrap the stream in a BufReader"]
    #[doc = "        let buf_reader = BufReader::new(stream.into_async_read());"]
    #[doc = "        let mut lines = buf_reader.lines();"]
    #[doc = "        assert_eq!(lines.next_line().await?, Some(\"hello!\".to_owned()));"]
    #[doc = "        assert_eq!(lines.next_line().await?, Some(\"This is some data\".to_owned()));"]
    #[doc = "        assert_eq!(lines.next_line().await?, None);"]
    #[doc = "        Ok(())"]
    #[doc = "    }"]
    #[doc = "    ```"]
    #[doc = ""]
    #[doc = "## Getting data into a ByteStream"]
    #[doc = "ByteStreams can be created in one of three ways:"]
    #[doc = "1. **From in-memory binary data**: ByteStreams created from in-memory data are always retryable. Data"]
    #[doc = "will be converted into `Bytes` enabling a cheap clone during retries."]
    #[doc = "    ```no_run"]
    #[doc = "    use bytes::Bytes;"]
    #[doc = "    use aws_smithy_http::byte_stream::ByteStream;"]
    #[doc = "    let stream = ByteStream::from(vec![1,2,3]);"]
    #[doc = "    let stream = ByteStream::from(Bytes::from_static(b\"hello!\"));"]
    #[doc = "    ```"]
    #[doc = ""]
    #[doc = "2. **From a file**: ByteStreams created from a path can be retried. A new file descriptor will be opened if a retry occurs."]
    #[doc = "    ```no_run"]
    #[doc = "    #[cfg(feature = \"tokio-rt\")]"]
    #[doc = "    # {"]
    #[doc = "    use aws_smithy_http::byte_stream::ByteStream;"]
    #[doc = "    let stream = ByteStream::from_path(\"big_file.csv\");"]
    #[doc = "    # }"]
    #[doc = "    ```"]
    #[doc = ""]
    #[doc = "3. **From an `SdkBody` directly**: For more advanced / custom use cases, a ByteStream can be created directly"]
    #[doc = "    from an SdkBody. **When created from an SdkBody, care must be taken to ensure retriability.** An SdkBody is retryable"]
    #[doc = "    when constructed from in-memory data or when using [`SdkBody::retryable`](crate::body::SdkBody::retryable)."]
    #[doc = "    ```no_run"]
    #[doc = "    use aws_smithy_http::byte_stream::ByteStream;"]
    #[doc = "    use aws_smithy_http::body::SdkBody;"]
    #[doc = "    use bytes::Bytes;"]
    #[doc = "    let (mut tx, channel_body) = hyper::Body::channel();"]
    #[doc = "    // this will not be retryable because the SDK has no way to replay this stream"]
    #[doc = "    let stream = ByteStream::new(SdkBody::from(channel_body));"]
    #[doc = "    tx.send_data(Bytes::from_static(b\"hello world!\"));"]
    #[doc = "    tx.send_data(Bytes::from_static(b\"hello again!\"));"]
    #[doc = "    // NOTE! You must ensure that `tx` is dropped to ensure that EOF is sent"]
    #[doc = "    ```"]
    #[doc = ""]
    #[derive(Debug)]
