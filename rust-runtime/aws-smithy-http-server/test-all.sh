...
echo "Testing feature: aws-lambda"
cargo check --no-default-features --features aws-lambda
cargo test --no-default-features --features aws-lambda
echo "Testing feature: request-id"
cargo check --no-default-features --features request-id
cargo test --no-default-features --features request-id
echo "Testing feature: unredacted-logging"
cargo check --no-default-features --features unredacted-logging
cargo test --no-default-features --features unredacted-logging
