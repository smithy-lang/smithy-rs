...
define_rejection! {
    #[status = BAD_REQUEST]
    #[body = "Request body do not contain valid UTF-8"]
...
composite_rejection! {
    /// Rejection used for content-type errors such has missing content-type
...
composite_rejection! {
    ...
    ///
    /// Contains one variant for each way the Smithy Rust Server can fail. It doesn't account for
    /// customer defined operation errors.
    ///
    /// This rejection implements all the errors that comes from other smithy-rs runtime crate,
