...
impl InterceptorRegistrar {
    /// Register an interceptor with this `InterceptorRegistrar`. When this `InterceptorRegistrar`
    /// is passed to an orchestrator, the orchestrator will run the registered interceptor for all
    /// the "hooks" that it implements.
