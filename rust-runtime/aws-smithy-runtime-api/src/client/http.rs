...
//! such test connector implementations are available in [`aws-smithy-runtime`](https://crates.io/crates/aws-smithy-runtime)
...
//! implemented. The `HyperConnector` in [`aws-smithy-runtime`](https://crates.io/crates/aws-smithy-runtime)
