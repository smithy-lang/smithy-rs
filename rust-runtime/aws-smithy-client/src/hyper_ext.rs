...
impl Builder {
        ...
        C::Error: Into<BoxError>,
    {
        ...
        let connector = match self.timeout_config.connect() {
        ...
        let http_timeout = match self.timeout_config.read() {
    ...
    pub fn timeout(self, timeout_config: &HttpConnectorTimeoutConfig) -> Self {
        Self {
...
mod timeout_middleware {
    ...
    mod test {
        ...
        async fn http_connect_timeout_works() {
            ...
            let timeout = HttpConnectorTimeoutConfig::new()
