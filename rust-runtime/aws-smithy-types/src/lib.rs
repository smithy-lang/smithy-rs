        ...
        impl TryFrom<Number> for $typ {
            ...
            fn try_from(value: Number) -> Result<Self, Self::Error> {
                match value {
                    ...
                    Number::NegInt(v) => Err(Self::Error::UnexpectedNegativeInteger(v)),
                    Number::Float(v) => Err(Self::Error::UnexpectedFloat(v)),
                }
            }
        }
    };
