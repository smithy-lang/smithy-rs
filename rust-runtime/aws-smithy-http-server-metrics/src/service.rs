...
pub struct MetricsLayerService<Ser, DefaultRq, DefaultRs, E, S, I, Rq, Rs>
where
    ...
    DefaultRq: Fn(&mut Request<ReqBody>, &mut AppendAndCloseOnDrop<E, S>) + Clone,
    DefaultRs: Fn(&mut Response<ResBody>, &mut AppendAndCloseOnDrop<E, S>) + Clone,
{
    pub(crate) inner: Ser,
    pub(crate) init_metrics: I,
    pub(crate) default_req_metrics_extension_fn: DefaultRq,
    pub(crate) default_res_metrics_extension_fn: DefaultRs,
    pub(crate) set_request_metrics: Option<Rq>,
    pub(crate) set_response_metrics: Option<Rs>,
}
impl<Ser, DefaultRq, DefaultRs, E, S, I, Rq, Rs> Clone
    for MetricsLayerService<Ser, DefaultRq, DefaultRs, E, S, I, Rq, Rs>
where
    Ser: Clone,
    E: CloseEntry + Send + Sync + 'static,
    S: EntrySink<RootEntry<E::Closed>> + Send + Sync + 'static,
...
impl<Ser, DefaultRq, DefaultRs, E, S, I, Rq, Rs> Service<Request<ReqBody>>
    for MetricsLayerService<Ser, DefaultRq, DefaultRs, E, S, I, Rq, Rs>
where
    ...
    DefaultRq: Fn(&mut Request<ReqBody>, &mut AppendAndCloseOnDrop<E, S>) + Clone,
    DefaultRs: Fn(&mut Response<ResBody>, &mut AppendAndCloseOnDrop<E, S>) + Clone + Send + 'static,
{
