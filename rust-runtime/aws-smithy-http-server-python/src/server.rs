...
use pyo3::{exceptions::PyException, prelude::*, types::IntoPyDict};
use signal_hook::{consts::*, iterator::Signals};
use tokio::runtime;
use tower::{util::ServiceFn, Layer, Service, ServiceBuilder};
...
"#,
        ...
        thread::spawn(move || {
            ...
            rt.block_on(async move {
                ...
                let service = ServiceBuilder::new()
                    ...
                    .layer(PyMiddlewareLayer::new(middlewares));
    ...
    ///
    ///     impl App {
    ///         pub fn build_router(&mut self, event_loop: &PyAny) -> PyResult<aws_smithy_http_server::Router> { todo!() }
    ///     }
    ///
    ///     impl PyApp for App {
...
#[pyclass]
#[derive(Debug)]
struct PyRequest(Request<Bytes>);
...
#[pyclass]
#[derive(Debug)]
struct PyResponse(Response<Bytes>);
...
impl PyMiddleware {
    ...
    pub fn new(handler: PyHandler) -> Self {
        PyMiddleware { handler }
    }
}

impl<S> Layer<S> for PyMiddleware {
    type Service = Middleware<S>;

    fn layer(&self, inner: S) -> Self::Service {
        Middleware::new(inner, self.handler.clone())
    }
}
...
impl<S> Middleware<S> {
    ...
    pub fn new(inner: S, handler: PyHandler) -> Self {
        Self { inner, handler }
    }
    ...
    pub fn layer(handler: PyHandler) -> PyMiddleware {
        PyMiddleware::new(handler)
    }
}

impl<S> Service<Request<Bytes>> for Middleware<S>
where
