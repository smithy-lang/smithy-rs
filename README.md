...
installation instructions on your platform. The MSRV (Minimum Support Rust Version) for the crates in this project is `stable-2`, i.e. the current `stable` Rust version and the prior two versions. Older versions may work.
