...
extra["displayName"] = "Smithy :: Rust :: Codegen :: Client :: Test"
extra["moduleName"] = "software.amazon.smithy.kotlin.codegen.client.test"
...
val workingDirUnderBuildDir = "smithyprojections/smithy-rust-codegen-client-test/"
...
data class ClientTest(
    ...
    private fun imports(): List<String> = dependsOn.map { "../smithy-rust-codegen-core/common-test-models/$it" }
}
