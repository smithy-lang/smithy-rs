...
data class ClientCodegenConfig(
     ...
     *
     * Note this is the setting for clients generated by smithy-rs generally; the AWS SDK has its own
     * `includeLegacyClient` in `SdkSettings`, and the SDK no longer enables the legacy stack by default.
     */
