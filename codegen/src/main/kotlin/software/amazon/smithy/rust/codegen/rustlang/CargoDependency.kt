...
class InlineDependency(
    ...
    companion object {
        ...
        fun errorCode(runtimeConfig: RuntimeConfig) = forRustFile("aws_json_errors", "aws_json_errors", "aws_json_errors.rs", CargoDependency.Http, CargoDependency.SmithyTypes(runtimeConfig))
