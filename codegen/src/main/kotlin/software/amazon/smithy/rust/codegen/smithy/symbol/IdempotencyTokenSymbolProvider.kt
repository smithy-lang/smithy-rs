...
class IdempotencyTokenSymbolProvider(private val base: SymbolProvider, private val runtimeConfig: RuntimeConfig) : WrappingSymbolProvider(base) {
    override fun toSymbol(shape: Shape): Symbol {
        ...
        return initial.toBuilder().setDefault(
            Default.Custom {
                write("\$T(\$T())", RuntimeType.UuidV4(runtimeConfig), RuntimeType.Random)
            }
        ).build()
    }
}
