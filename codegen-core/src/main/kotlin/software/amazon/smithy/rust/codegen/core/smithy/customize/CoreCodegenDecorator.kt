...
interface CoreCodegenDecorator<CodegenContext> {
     ...
     */
    fun extraSections(codegenContext: CodegenContext): List<Pair<AdHocCustomization<*>, (Section) -> Writable>> = listOf()
}
...
abstract class CombinedCoreCodegenDecorator<CodegenContext, Decorator : CoreCodegenDecorator<CodegenContext>>(
    ...
    final override fun extraSections(codegenContext: CodegenContext): List<Pair<AdHocCustomization<*>, (Section) -> Writable>> =
