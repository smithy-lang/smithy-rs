...
data class RuntimeType(val path: String, val dependency: RustDependency? = null) {
    ...
    companion object {
        ...
        fun genericError(runtimeConfig: RuntimeConfig) = smithyTypes(runtimeConfig).resolve("error::Error")
        fun genericErrorBuilder(runtimeConfig: RuntimeConfig) = smithyTypes(runtimeConfig).resolve("error::Builder")
        fun provideErrorMetadataTrait(runtimeConfig: RuntimeConfig) = smithyTypes(runtimeConfig).resolve("error::ProvideErrorMetadata")
