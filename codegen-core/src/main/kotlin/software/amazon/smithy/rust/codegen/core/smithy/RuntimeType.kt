...
data class RuntimeType(val path: String, val dependency: RustDependency? = null) {
    ...
    companion object {
        ...
        fun futuresStreamCompatEventStream(runtimeConfig: RuntimeConfig): RuntimeType =
            smithyHttp(runtimeConfig).resolve("futures_stream_adapter::FuturesStreamCompatEventStream")
