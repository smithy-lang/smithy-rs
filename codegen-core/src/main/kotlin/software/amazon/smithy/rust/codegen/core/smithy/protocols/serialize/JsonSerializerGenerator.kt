...
class JsonSerializerGenerator(
    ...
    override fun unsetStructure(structure: StructureShape): RuntimeType =
        ProtocolFunctions.crossOperationFn(codegenContext.protocolSerdeModule, "rest_json_unset_struct_payload") { fnName ->
            rustTemplate(
                """
    ...
    override fun unsetUnion(union: UnionShape): RuntimeType =
        ProtocolFunctions.crossOperationFn(codegenContext.protocolSerdeModule, "rest_json_unset_union_payload") { fnName ->
            rustTemplate(
    ...
    override fun documentSerializer(): RuntimeType {
        return ProtocolFunctions.crossOperationFn(codegenContext.protocolSerdeModule, "serialize_document") { fnName ->
            rustTemplate(
                """
