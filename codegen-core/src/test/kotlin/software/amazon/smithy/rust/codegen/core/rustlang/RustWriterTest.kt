...
class RustWriterTest {
    ...
    fun `json files do not have header comment`(debugMode: Boolean) {
        val factory = RustWriter.factory(debugMode = debugMode)
        val writer = factory.apply("example.json", "test")
        writer.rust("""{"key": "value"}""")
        val output = writer.toString()
        output shouldNotContain "Code generated by software.amazon.smithy.rust.codegen.smithy-rs. DO NOT EDIT."
        output shouldContain """{"key": "value"}"""
    }
}
