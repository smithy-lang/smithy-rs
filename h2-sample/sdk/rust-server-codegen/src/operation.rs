...
static CONTENT_TYPE_SAMPLEOPERATION: std::sync::LazyLock<::mime::Mime> =
...
::pin_project_lite::pin_project! {
    ...
    pub struct SampleOperationInputFuture {
        inner: std::pin::Pin<Box<dyn std::future::Future<Output = Result<crate::input::SampleOperationInput, ::aws_smithy_http_server::protocol::rpc_v2_cbor::runtime_error::RuntimeError>> + Send>>
    }
}
